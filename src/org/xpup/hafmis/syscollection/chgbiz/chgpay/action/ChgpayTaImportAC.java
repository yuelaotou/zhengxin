 ...
 */
public class ChgpayTaImportAC extends Action {
  /*
   * Generated Methods
   */
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    ChgpayImportTaAF forms = (ChgpayImportTaAF) form;
    ...
    String jasperSrc = context.getRealPath("/impXml/" + "chgpay_imp.xml");
    ...
    try {
      ...
      info = faxtory.getInfomation(xmlfile, stream,"org.xpup.hafmis.syscollection.chgbiz.chgpay.dto.");
    } catch (Exception e) {
    ...
    List addchgpayHeadImportList = (List) info
        .get("ChgpayHeadImport");
    List addchgpayListImportList = (List) info
        .get("ChgpayListImport");
    IChgpayBS chgpayBS = (IChgpayBS) BSUtils.getBusinessService("chgpayBS", this,
        mapping.getModuleConfig());

    List failList = null;
    try {
      failList = chgpayBS.addChgpayListBatch(addchgpayHeadImportList,addchgpayListImportList,orgId,chgMonth,ip,name,date,securityInfo);
      if(failList!=null){
      if (failList.size() > 0) {
