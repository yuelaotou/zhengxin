...
public class ChgslarybaseListAF extends  ActionForm {
  ...
  private List list;
  private List totalorgChgPaymentSalaryBase;
  ...
  public void reset(Map map,List list,String startBizDate ,String endBizDate,String startChgMonth ,
      String endChgMonth,String collectionBankId ,String orgName ,String officecode,
      String orgId ,Integer chgStatus){
  ...
  public List getTotalorgChgPaymentSalaryBase() {
    return totalorgChgPaymentSalaryBase;
  }

  public void setTotalorgChgPaymentSalaryBase(List totalorgChgPaymentSalaryBase) {
    this.totalorgChgPaymentSalaryBase = totalorgChgPaymentSalaryBase;
  }
