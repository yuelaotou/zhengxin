...
public class OrgAccountInfoTbShowAC extends Action {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    try{
      ...
      Pagination pagination = getPagination(OrgAccountInfoTbShowAC.PAGINATION_KEY, request); 
      ...
      List list=orgAccountInfoBS.findOrgAccountInfoByMonth(pagination, securityInfo);
      OrgAccountInfoTotalDTO totaldto=orgAccountInfoBS.findOrgAccountInfoMonthTotal(pagination, securityInfo);
