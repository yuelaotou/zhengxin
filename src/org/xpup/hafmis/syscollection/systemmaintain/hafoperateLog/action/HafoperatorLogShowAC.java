...
import org.xpup.hafmis.syscollection.systemmaintain.hafoperateLog.form.HafoperateLogAF;
...
public class HafoperatorLogShowAC extends Action{
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    try{
      ...
      IHafoperatorLogBS hafoperatorLogBS = (IHafoperatorLogBS) BSUtils.getBusinessService("hafoperatorLogBS", this, mapping.getModuleConfig());
      /**
       * ∑÷“≥
       */  
      ...
      af.setOpmodlemap(BusiTools.listBusiProperty(BusiLogConst.OPMODECOLL));
      af.setOpactionmap(BusiTools.listBusiProperty(BusiLogConst.BIZLOG_ACTION));
      af.getOpactionmap().remove(new Integer(BusiLogConst.BIZLOG_ACTION_ENDCHG+"")); 
      af.getOpactionmap().remove(new Integer(BusiLogConst.BIZLOG_ACTION_AUDITINGPASS+""));
      af.getOpactionmap().remove(new Integer(BusiLogConst.BIZLOG_ACTION_AUDITING+""));
      af.getOpactionmap().remove(new Integer(BusiLogConst.BIZLOG_ACTION_AUDITINGQUASH+""));
      af.getOpactionmap().remove(new Integer(BusiLogConst.BIZLOG_ACTION_PPROVALPASS+""));
      af.getOpactionmap().remove(new Integer(BusiLogConst.BIZLOG_ACTION_PPROVAL+""));
      af.getOpactionmap().remove(new Integer(BusiLogConst.BIZLOG_ACTION_PPROVALQUASH+""));
      af.getOpactionmap().remove(new Integer(BusiLogConst.BIZLOG_ACTION_CARRYFORWARD+""));
  ...
  private Pagination getPagination(String paginationKey,
    ...
    Pagination pagination = (Pagination) request.getSession().getAttribute(
        paginationKey);
    if (pagination == null) {
      pagination = new Pagination(0, 10, 1, "hafOperateLog.id", "DESC",
          new HashMap(0));
