 ...
 */
public class SurrogateMaintainAC extends LookupDispatchAction {
  ...
  public ActionForward add(ActionMapping mapping, ActionForm form,
    ...
    return mapping.findForward("to_surrogate_addupdate");
  }
  ...
  public ActionForward update(ActionMapping mapping, ActionForm form,
      ...
      SurrogateAFDTO surrogateAF=null;
      try{

        ISurrogateBS surrogateBS=(ISurrogateBS)BSUtils
        .getBusinessService("surrogateBS", this, mapping.getModuleConfig());
        surrogateAF=surrogateBS.findSurrogateID(new Integer(id));
        Map map = BusiTools.listBusiProperty(BusiConst.DOCUMENTSSTATE);
        surrogateAF.setMap(map);
        surrogateAF.setType("修改");
  ...
  public ActionForward remove(ActionMapping mapping, ActionForm form,
    ...
    try{
      ...
      boolean is_asistantOrg=surrogateBS.is_Surrogate_YM(new Integer(id));
      if(is_asistantOrg)
      {
        error="该记录已经删除!";
      }
      ...
      {
        surrogateBS.deleteSurrogate(new Integer(id),securityInfo);
        error="删除成功!";
      }
    }
    catch(Exception e)
