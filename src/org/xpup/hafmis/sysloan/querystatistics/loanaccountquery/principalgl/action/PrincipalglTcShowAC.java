 ...
 *
 */
public class PrincipalglTcShowAC extends Action{
  public static final String PAGINATION_KEY = "org.xpup.hafmis.sysloan.querystatistics.loanaccountquery.principalgl.action.PrincipalglTcShowAC";
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    principalglTaAF = principalglBS.queryListByDay(tempId, date, pagination2, securityInfo,radioValue, floorname);
    request.getSession().setAttribute("principalglTclist", principalglTaAF.getPrintlist());
    request.setAttribute("theprincipalglTaAF", principalglTaAF);
    request.getSession().setAttribute(PAGINATION_KEY, pagination2);
    return mapping.findForward("to_principalglTc_show");
  }
