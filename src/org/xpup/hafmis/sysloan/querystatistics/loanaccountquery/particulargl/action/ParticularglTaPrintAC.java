 ...
 */
public class ParticularglTaPrintAC extends Action {
	/*
	 * Generated Methods
	 */
    ...
    ParticularglTaAF particularglTaAF=(ParticularglTaAF)request.getSession().getAttribute("toprintparticularglTaAF");
    ...
    request.getSession().setAttribute("toprintparticularglTaAF", null);
    
    return mapping.findForward("particulargl_ta_print");
  }
