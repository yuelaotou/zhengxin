 ...
 */
public class ParticularglTbPrintAC extends Action {
	/*
	 * Generated Methods
	 */
 ...
 ParticularglTaAF particularglTaAF=(ParticularglTaAF)request.getSession().getAttribute("toprinttbparticularglTaAF");
    ...
    request.getSession().setAttribute("toprinttbparticularglTaAF", null);
    
    return mapping.findForward("particulargl_tb_print");
	}
}