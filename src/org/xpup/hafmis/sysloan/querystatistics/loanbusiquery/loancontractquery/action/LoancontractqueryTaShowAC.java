 ...
 * 
 * XDoclet definition:
 * @struts.action path="/loancontractqueryTaShowAC" name="loanapplynewAF" scope="request" validate="true"
 */
public class LoancontractqueryTaShowAC extends Action {
	/*
	 * Generated Methods
	 */
    ...
    try {
      String contractid = (String) request.getSession().getAttribute(
          "contractIdWY");
      contractId = (String) request.getParameter("contractIdHl");
    ...
    return mapping.findForward("loancontractquery_ta_cell");
  }
}