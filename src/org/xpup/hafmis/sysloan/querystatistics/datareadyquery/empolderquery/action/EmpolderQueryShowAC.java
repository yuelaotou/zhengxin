 ...
 * @author 付云峰
 */
public class EmpolderQueryShowAC extends Action {

  public static final String PAGINATION_KEY = "org.xpup.hafmis.sysloan.querystatistics.datareadyquery.empolderquery.action.EmpolderQueryShowAC";
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    try {
      ...
      // 得到列表中的内容
      List list = developBS.findDevelopList_info(pagination, securityInfo);
    ...
    return mapping.findForward("to_empolderquery_find");
  }
  ...
  private Pagination getPagination(String paginationKey,
    ...
    Pagination pagination = (Pagination) request.getSession().getAttribute(
        paginationKey);
    if (pagination == null) {
      pagination = new Pagination(0, 10, 1, "p5.developer_code", "ASC",
          new HashMap(0));
