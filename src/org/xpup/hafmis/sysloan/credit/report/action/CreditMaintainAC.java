...
public class CreditMaintainAC extends LookupDispatchAction {
   ...
   * @return
   */
  public ActionForward zhengchangshuju(ActionMapping mapping, ActionForm form,
    ...
    try {
      ...
      ICreditBS creditBS = (ICreditBS) BSUtils.getBusinessService("creditBS",
      ...
      String shujutiquriqi = (String) pagination.getQueryCriterions().get(
          "shujutiquriqi");
      String filename = "E3330121080001" + shujutiquriqi + "001" + "1" + "000";
