 ...
 */
public class LoanreturnedbyfundTaAssiFindAAC extends Action {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    try {
      ...
      try {
        ...
        request.getSession().setAttribute("empinfoDto_s", assistantBorrower);
      } catch (Exception e) {
        String text = "";
        text = "display2('" + e.getLocalizedMessage().toString() + "')";
        response.getWriter().write(text);
        response.getWriter().close();
      }
    } catch (Exception e) {
