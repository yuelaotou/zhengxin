 ...
 */
public class LoanreturnedbyfundTaAssiFindAACA extends Action {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    try {
      ...
      try {
        ...
        request.getSession().setAttribute("empinfoDto_sa", assistantBorrower);
      } catch (Exception e) {
        String text = "";
        text = "display3('" + e.getLocalizedMessage().toString() + "')";
        response.getWriter().write(text);
        response.getWriter().close();
      }
    } catch (Exception e) {
