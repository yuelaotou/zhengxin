 ...
 */
public class LoanapplyTbFindAAC extends Action {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
   ...
   request.getSession().setAttribute("contractid", contractId);
    ...
    try {
      loanapplyBS.checkContractIdByContractId(contractId);
      request.getSession().setAttribute("contractid", contractId);
      String text = "";
      text = "displaycontractId('"+contractId+"')";
      response.getWriter().write(text);
      response.getWriter().close();
    } catch (BusinessException e) {
      String text = "";
      text = "display('"+e.getLocalizedMessage().toString()+"')";
      response.getWriter().write(text);
      response.getWriter().close();
    }
