...
public class IssuenoticeTcFindAC extends Action {
  ...
  protected String getPaginationKey() {
    return IssuenoticeTcShowAC.PAGINATION_KEY;
  }
  ...
  protected HashMap makeCriterionsMap(IssuenoticeTbAF form) {
    ...
    String contractSt=form.getIschecked();
    if (!(contractSt == null || contractSt.length() == 0)) {
      m.put("contractSt", form.getIschecked().trim());
    }
