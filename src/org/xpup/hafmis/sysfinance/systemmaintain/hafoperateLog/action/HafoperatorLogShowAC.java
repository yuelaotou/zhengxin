...
public class HafoperatorLogShowAC extends Action{
  ...
  public static final String PAGINATION_KEY = "org.xpup.hafmis.sysfinance.systemmaintain.hafoperateLog.action.HafoperatorLogShowAC";
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    try{
      ...
      af.setOpmodlemap(BusiTools.listBusiProperty(BusiLogConst.OPMODEFINANCE));
