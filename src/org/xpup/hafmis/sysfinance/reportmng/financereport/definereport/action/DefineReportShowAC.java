...
public class DefineReportShowAC extends Action {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    DefineReportAF defineReportAF = new DefineReportAF();
    try {
      ...
      defineReportAF=defineReportBS.queryReportMessage(defineReportAF,pagination,securityInfo);
    ...
    return mapping.findForward("to_definereport_show");
  }
