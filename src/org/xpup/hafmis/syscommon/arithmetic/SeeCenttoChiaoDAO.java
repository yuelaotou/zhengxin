 ...
 *2007-6-21
 */
public class SeeCenttoChiaoDAO implements ArithmeticInterface{
  ...
  public BigDecimal getPay(BigDecimal salaryBase, BigDecimal rate) {
    ...
    pay = new BigDecimal((p+0.04)*10);
    pay = pay.multiply(new BigDecimal(0.1)).divide(new BigDecimal(1),1,BigDecimal.ROUND_HALF_UP);
  ...
  public BigDecimal getPay(BigDecimal pay) {
    // TODO Auto-generated method stub
    pay = pay.add(new BigDecimal(0.04)).multiply(new BigDecimal(10));
    pay = pay.multiply(new BigDecimal(0.1)).divide(new BigDecimal(1),1,BigDecimal.ROUND_HALF_UP);
