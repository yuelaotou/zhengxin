...
function counter(){
 	...
 	if (myTime<100)setTimeout("counter()",10); 
...
function showselect()
{
	...
	<body>
		<div id="showbankinfo"
			style="position:absolute; display:none;  background-color:#F99F6F; left:200px; top:350px; width:300px; height:30px; z-index:1;">
