...
<%@ page import="org.xpup.hafmis.sysfinance.bookmng.subject.action.SubjectTdShowAC" %>
<%
   Object pagination= request.getSession(false).getAttribute(SubjectTdShowAC.PAGINATION_KEY);
          ...
          <td background="<%=path %>/img/table_bg_line.gif">
              <table border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  ...
                  <td width="112" height="37" background="<%=path %>/img/buttonbl.gif" align="center"   style="PADDING-top: 7px" valign="top">成本</td>
  ...
  <%	
  		...
  		for(int i=0;i<rank1.size();i++){
	        ...
	        <td>
  				...
  				<a href="#" onclick="document.URL='subjectModifyAC.do?sortcodeflag=3&subjectId=<%=subject1.getSubjectId() %>'" class="font14"><%=subject1.getSubjectCode() %>&nbsp;<%=subject1.getSubjectName() %></a>
  			</td>
  			</tr>
  				...
  				if(subject2.getParentSubjectCode().equals(subject1.getSubjectCode())){
  					...
  					<tr id='tr<%=i+"_"+j%>' style="display:none" >
  					  <td>&nbsp;&nbsp;&nbsp;&nbsp;
		  				...
		  				<a href="#" onclick="document.URL='subjectModifyAC.do?sortcodeflag=3&subjectId=<%=subject2.getSubjectId() %>'" class="font14"><%=subject2.getSubjectCode() %>&nbsp;<%=subject2.getSubjectName() %></a>
		  			  </td>
		  			</tr>
  					<%for(int k=0;k<rank3.size();k++){
  						...
  						if(subject3.getParentSubjectCode().equals(subject2.getSubjectCode())){
				  			...
				  			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  				...
				  				<a href="#" onclick="document.URL='subjectModifyAC.do?sortcodeflag=3&subjectId=<%=subject3.getSubjectId() %>'" class="font14"><%=subject3.getSubjectCode() %>&nbsp;<%=subject3.getSubjectName() %></a>
				  			</td>
				  			</tr>
				  			<%for(int m=0;m<rank4.size();m++){
					  			...
					  			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					  				...
					  				<a href="#" onclick="document.URL='subjectModifyAC.do?sortcodeflag=3&subjectId=<%=subject4.getSubjectId() %>'" class="font14"><%=subject4.getSubjectCode() %>&nbsp;<%=subject4.getSubjectName() %></a>
					  			</td>
					  			</tr>
					  			<%for(int n=0;n<rank5.size();n++){
						  			...
						  			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  				...
						  				<a href="#" onclick="document.URL='subjectModifyAC.do?sortcodeflag=3&subjectId=<%=subject5.getSubjectId() %>'" class="font14" ><%=subject5.getSubjectCode() %>&nbsp;<%=subject5.getSubjectName() %></a>
						  			</td>
						  			</tr>
						  			<%for(int h=0;h<rank6.size();h++){
							  			...
							  			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							  				...
							  				<a href="#" onclick="document.URL='subjectModifyAC.do?sortcodeflag=3&subjectId=<%=subject6.getSubjectId() %>'" class="font14"><%=subject6.getSubjectCode() %>&nbsp;<%=subject6.getSubjectName() %></a>
							  			</td>
							  			</tr>
  												<%
  												}
