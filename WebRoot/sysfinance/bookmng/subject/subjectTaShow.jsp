...
<%@ page
	import="org.xpup.hafmis.sysfinance.bookmng.subject.action.SubjectTaShowAC"%>
<%
			Object pagination = request.getSession(false).getAttribute(
			SubjectTaShowAC.PAGINATION_KEY);
								...
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="112" height="37"
											...
											<a href="subjectTbForwardAC.do" class=a2>负债</a>
										</td>
										<td width="112" height="37"
											background="<%=path%>/img/buttong.gif" align="center"
											style="PADDING-top: 7px" valign="top">
											<a href="subjectTcForwardAC.do" class=a2>权益</a>
										</td>
										<td width="112" height="37"
											background="<%=path%>/img/buttong.gif" align="center"
											style="PADDING-top: 7px" valign="top">
											<a href="subjectTdForwardAC.do" class=a2>成本</a>
										</td>
										<td width="112" height="37"
											background="<%=path%>/img/buttong.gif" align="center"
											style="PADDING-top: 7px" valign="top">
											<a href="subjectTeForwardAC.do" class=a2>损益</a>
										</td>
									</tr>
								</table>
							</td>
			...
			<tr>
				<td class=td3 height="7" style="line-height:150%">
					...
					<%
							...
							switch (Integer.parseInt((String) subject
									.getSubjectLevel())) {
							case 1:
								rank1.add(subject);
								break;
					...
					<TABLE width="95%" border="0" cellspacing="1" cellpadding="1"
						...
						<tr id='tr<%=i%>'>
							<td>
								...
								<a onclick="hide('<%=i%>');"><img id="img<%=i%>"
										src="<%=path%>/img/fold.gif" />
								</a>
								<INPUT id='<%=i%>' type="radio" name="radioname"
									value="<%=subject1.getSubjectId()%>"
									onclick="return checkradio(<%=subject1.getSubjectSt()%>);">
								<a href="#"
									onclick="document.URL='subjectModifyAC.do?sortcodeflag=0&subjectId=<%=subject1.getSubjectId()%>'"
									class="font14"><%=subject1.getSubjectCode()%>&nbsp;<%=subject1.getSubjectName()%>
								</a>
							</td>
						</tr>
						<%
									...
									if (subject2.getParentSubjectCode().equals(
									subject1.getSubjectCode())) {
						%>
						<tr id='tr<%=i + "_" + j%>' style="display:none">
							<td>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="hidden" id="hid<%=i + "_" + j%>" name="2">
								<a onclick="hide('<%=i + "_" + j%>')"><img id="img<%=i + "_" + j%>"
										src="<%=path%>/img/fold.gif" />
								</a>
								<INPUT id='<%=i + "_" + j%>' type="radio" name="radioname"
									value="<%=subject2.getSubjectId()%>"
									onclick="return checkradio(<%=subject2.getSubjectSt()%>);">
								<a href="#"
									onclick="document.URL='subjectModifyAC.do?sortcodeflag=0&subjectId=<%=subject2.getSubjectId()%>'"
									class="font14"><%=subject2.getSubjectCode()%>&nbsp;<%=subject2.getSubjectName()%>
								</a>
							</td>
						</tr>
						<%
									...
									if (subject3.getParentSubjectCode().equals(
											subject2.getSubjectCode())) {
						%>
						<tr id='tr<%=i + "_" + j + "-" + k%>' style="display:none">
							<td>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="hidden" id="hid<%=i + "_" + j + "-" + k%>" name="3">
								<a onclick="hide('<%=i + "_" + j + "-" + k%>')"><img
										id="img<%=i + "_" + j + "-" + k%>" src="<%=path%>/img/fold.gif" />
								</a>
								<INPUT id='<%=i + "_" + j + "-" + k%>' type="radio" name="radioname"
									value="<%=subject3.getSubjectId()%>"
									onclick="return checkradio(<%=subject3.getSubjectSt()%>);">
								<a href="#"
									onclick="document.URL='subjectModifyAC.do?sortcodeflag=0&subjectId=<%=subject3.getSubjectId()%>'"
									class="font14"><%=subject3.getSubjectCode()%>&nbsp;<%=subject3.getSubjectName()%>
								</a>
							</td>
						</tr>
						<%
											...
											subject4 = (SubjectDTO) rank4
											.get(m);
											if (subject4
											.getParentSubjectCode()
											.equals(
											subject3
													.getSubjectCode())) {
						%>
						<tr id='tr<%=i + "_" + j
														+ "-" + k + "_" + m%>' style="display:none">
							<td>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="hidden" id="hid<%=i + "_" + j
														+ "-" + k + "_" + m%>" name="4">
								<a onclick="hide('<%=i + "_" + j
														+ "-" + k + "_" + m%>')"><img
										id="img<%=i + "_" + j
														+ "-" + k + "_" + m%>" src="<%=path%>/img/fold.gif" />
								</a>
								<INPUT id='<%=i + "_" + j
														+ "-" + k + "_" + m%>' type="radio"
									name="radioname" value="<%=subject4
																		.getSubjectId()%>"
									onclick="return checkradio(<%=subject4
																		.getSubjectSt()%>);">
								<a href="#"
									onclick="document.URL='subjectModifyAC.do?sortcodeflag=0&subjectId=<%=subject4
																		.getSubjectId()%>'"
									class="font14"><%=subject4
																		.getSubjectCode()%>&nbsp;<%=subject4
																		.getSubjectName()%>
								</a>
							</td>
						</tr>
						...
						<tr id='tr<%=i + "_"
							...
							<td>
								...
								<INPUT id='<%=i + "_"
																...
																+ "_" + m + "-"
																+ n%>' type="radio"
									name="radioname" value="<%=subject5
																				.getSubjectId()%>"
									onclick="return checkradio(<%=subject5
																				.getSubjectSt()%>);">
								<a href="#"
									onclick="document.URL='subjectModifyAC.do?sortcodeflag=0&subjectId=<%=subject5
																				.getSubjectId()%>'"
									class="font14"><%=subject5
																				.getSubjectCode()%>&nbsp;<%=subject5
																				.getSubjectName()%>
								</a>
							</td>
						</tr>
						...
						<tr id='tr<%=i
							...
							<td>
								...
								<INPUT id='<%=i
																		...
																		+ "_"
																		+ h%>' type="radio"
									name="radioname" value="<%=subject6
																						.getSubjectId()%>"
									onclick="return checkradio(<%=subject6
																						.getSubjectSt()%>);">
								<a href="#"
									onclick="document.URL='subjectModifyAC.do?sortcodeflag=0&subjectId=<%=subject6
																						.getSubjectId()%>'"
									class="font14"><%=subject6
																						.getSubjectCode()%>&nbsp;<%=subject6
																						.getSubjectName()%>
								</a>
							</td>
						</tr>
							...
							<td colspan="7" bgcolor="#FFFFFF" align="center" height="30">
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="70">
											<html:submit property="method" styleClass="buttona"
												onclick="return is_delete();">
												<bean:message key="button.delete" />
											</html:submit>
										</td>
										<td width="70">
											<html:submit property="method" styleClass="buttona"
												onclick="return is_canceled();">
												<bean:message key="button.canceled" />
											</html:submit>
										</td>
										<td width="70">
											<html:submit property="method" styleClass="buttona"
												onclick="return is_canceledquash();">
