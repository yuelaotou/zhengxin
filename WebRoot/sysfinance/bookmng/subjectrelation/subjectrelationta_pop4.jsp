...
<%
	...
	Object pagination = request.getSession().getAttribute(
			SubjectRelationTaPop4AC.PAGINATION_KEY);
...
<body bgcolor="#FFFFFF" text="#000000" onContextmenu="return false"
	...
	<table width="95%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td class=td3>
				<html:form action="/subjectrelationTaSave4AC.do" style="margin: 0">
					<table width="95%" border="0" cellspacing="0" cellpadding="0"
						align="center">
						<tr>
							<td height="35">
					...
					<table width="95%" border="0" cellspacing="0" cellpadding="3"
						...
						<logic:notEmpty name="subjectrelaionTaPop1AF" property="list">
							<logic:iterate id="element" name="subjectrelaionTaPop1AF"
								property="list" indexId="i">
								<tr>
									<td>
										<html:hidden name="element" property="id"></html:hidden>
									<td valign="top">
										<p>
											<bean:write name="element" property="name" format="000000" />
										</p>
									</td>
								</tr>
								<tr>
						...
						<logic:empty name="subjectrelaionTaPop1AF" property="list">
							<tr>
									...
									<tr>
										...
										<td align="right">
											<jsp:include page="../../../inc/pagination.jsp">
												<jsp:param name="url" value="subjectRelationTaPop4AC.do" />
											</jsp:include>
										</td>
									</tr>
								</table>
								...
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<logic:notEmpty name="subjectrelaionTaPop1AF" property="list">
											...
											<td width="69" align="right">
												<html:submit property="method" styleClass="buttona" onclick="return back();">
													<bean:message key="button.back" />
												</html:submit>
											</td>
										</logic:notEmpty>
