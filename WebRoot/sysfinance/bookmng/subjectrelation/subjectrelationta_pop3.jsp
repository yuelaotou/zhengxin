...
<%
	...
	Object pagination = request.getSession().getAttribute(
			SubjectRelationTaPop3AC.PAGINATION_KEY);
	...
	<table width="95%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td class=td3>
				...
				<html:form action="/subjectRelationPop3FindAC">
						...
						<tr>
							...
							<td width="18%">
								<html:select property="loanBankId" styleClass="input4"
									name="subjectrelationTaPop3AF" onkeydown="enterNextFocus1();">
									<option value=""></option>
				...
				<html:form action="/subjectrelationTaSave3AC.do" style="margin: 0">
					<table width="95%" border="0" cellspacing="0" cellpadding="0"
						align="center">
						<tr>
							<td height="35">
					...
					<table width="95%" border="0" cellspacing="0" cellpadding="3"
						...
						<logic:notEmpty name="subjectrelaionTaPop3AF" property="list">
							<logic:iterate id="element" name="subjectrelaionTaPop3AF"
								...
								<tr>
									...
									<td valign="top">
										<p>
											<bean:write name="element" property="bankName" />
										</p>
									</td>
									<td valign="top">
										<p>
						...
						<logic:empty name="subjectrelaionTaPop3AF" property="list">
							<tr>
									...
									<tr>
										...
										<td align="right">
											<jsp:include page="../../../inc/pagination.jsp">
												<jsp:param name="url" value="subjectRelationTaPop3AC.do" />
											</jsp:include>
										</td>
									</tr>
								</table>
