...
function showOrHide(sid,id,parent_level){
	...
	if(obj.style.display=="none"&&parseInt(hid)==parseInt(parent_level)+1){
		obj.style.display=""; 
		document.getElementById("img"+sid).src="<%=path %>/img/NodeImg2.gif";
		var url=document.getElementById("img"+id).src;
		var u=url.substring(url.indexOf(".")-1,url.indexOf("."));
		if(u=='1'){
			document.getElementById("img"+id).src="<%=path %>/img/NodeImg1.gif";
		}
		//if(document.getElementById("img"+id).src!="<%=path %>/img/NodeImg0.gif"){
			//document.getElementById("img"+id).src="<%=path %>/img/NodeImg1.gif";
		//}
		//document.getElementById("img"+sid).src="<%=path %>/img/NodeImg2.gif";
		//document.getElementById("img"+id).src="<%=path %>/img/fold.gif";
		//document.getElementById("img"+sid).src="<%=path %>/img/open.gif";
		//document.getElementById("img"+sid).src="<%=path %>/img/NodeImg0.gif";
	}else{
		obj.style.display="none";
		if(parseInt(hid)==parseInt(parent_level)+1){
			document.getElementById("img"+sid).src="<%=path %>/img/NodeImg1.gif";
			var url=document.getElementById("img"+id).src;
			var u=url.substring(url.indexOf(".")-1,url.indexOf("."));
			if(u=='2'){
				document.getElementById("img"+id).src="<%=path %>/img/NodeImg1.gif";
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr>
          ...
          <td background="<%=path %>/img/table_bg_line.gif">
              <table border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <!--  <td width="112" height="37" background="<%=path %>/img/buttonbl.gif" align="center" valign="top"  style="PADDING-top: 7px">资产</td>
                  ...
                  <td width="112" height="37" background="<%=path %>/img/buttong.gif" align="center"   style="PADDING-top: 7px" valign="top"><a href="subjectpopTcShowAC.do" class=a2>权益</a></td>
  ...
  <%	
  		...
  		SubjectDTO subject2_yg=null;
  		SubjectDTO subject3_yg=null;
  		SubjectDTO subject4_yg=null;
  		SubjectDTO subject5_yg=null;
  		SubjectDTO subject6_yg=null;
  		String yg2="a";
  		String yg3="a";
  		String yg4="a";
  		String yg5="a";
  		...
  		for(int i=0;i<rank1.size();i++){
	        ...
	        <td>
  				...
  				<%
  					yg2="a";
  					for(int i_yg=0;i_yg<rank2.size();i_yg++){
  						subject2_yg=new SubjectDTO();
  						subject2_yg=(SubjectDTO)rank2.get(i_yg);
  						if(subject2_yg.getParentSubjectCode().equals(subject1.getSubjectCode())){
  							yg2="b";
  						}
  					}
  					if(yg2.equals("b")){
  				%>
  						<a onclick="hide('<%=i %>');"><img id="img<%=i%>" src="<%=path %>/img/NodeImg1.gif"/></a>
  				<% 
  					}else{
  				%>
  						<a onclick="hide('<%=i %>');"><img id="img<%=i%>" src="<%=path %>/img/NodeImg0.gif"/></a>
  				<% 
  					}
  				%>
  				...
  				if(subject2.getParentSubjectCode().equals(subject1.getSubjectCode())){
  					...
  					<tr id='tr<%=i+"_"+j%>' style="display:none" onDblClick='dbfnqdValues("<%=subject2.getSubjectCode() %>");'>
  					  <td>&nbsp;&nbsp;&nbsp;&nbsp;
  					  	...
  					  	<%
  					  		yg3="a";
		  					for(int j_yg=0;j_yg<rank3.size();j_yg++){
		  						subject3_yg=new SubjectDTO();
		  						subject3_yg=(SubjectDTO)rank3.get(j_yg);
		  						if(subject3_yg.getParentSubjectCode().equals(subject2.getSubjectCode())){
		  							yg3="b";
		  						}
		  					}
		  					if(yg3.equals("b")){
		  				%>
		  						<a onclick="hide('<%=i+"_"+j%>')"><img id="img<%=i+"_"+j%>" src="<%=path %>/img/NodeImg1.gif"/></a>
		  				<% 
		  					}else{
		  				%>
		  						<a onclick="hide('<%=i+"_"+j%>')"><img id="img<%=i+"_"+j%>" src="<%=path %>/img/NodeImg0.gif"/></a>
		  				<% 
		  					}
		  				%>
  					...
  					<%for(int k=0;k<rank3.size();k++){
  						...
  						if(subject3.getParentSubjectCode().equals(subject2.getSubjectCode())){
				  			...
				  			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  					  			...
  					  			<%
  					  				yg4="a";
				  					for(int k_yg=0;k_yg<rank4.size();k_yg++){
				  						subject4_yg=new SubjectDTO();
				  						subject4_yg=(SubjectDTO)rank4.get(k_yg);
				  						if(subject4_yg.getParentSubjectCode().equals(subject3.getSubjectCode())){
				  							yg4="b";
				  						}
				  					}
				  					if(yg4.equals("b")){
				  				%>
				  						<a onclick="hide('<%=i+"_"+j+"-"+k%>')"><img id="img<%=i+"_"+j+"-"+k%>" src="<%=path %>/img/NodeImg1.gif"/></a>
				  				<% 
				  					}else{
				  				%>
				  						<a onclick="hide('<%=i+"_"+j+"-"+k%>')"><img id="img<%=i+"_"+j+"-"+k%>" src="<%=path %>/img/NodeImg0.gif"/></a>
				  				<% 
				  					}
				  				%>
				  			...
				  			<%for(int m=0;m<rank4.size();m++){
					  			...
					  			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  									...
  									<%
  										yg5="a";
					  					for(int m_yg=0;m_yg<rank5.size();m_yg++){
					  						subject5_yg=new SubjectDTO();
					  						subject5_yg=(SubjectDTO)rank5.get(m_yg);
					  						if(subject5_yg.getParentSubjectCode().equals(subject4.getSubjectCode())){
					  							yg5="b";
					  						}
					  					}
					  					if(yg5.equals("b")){
					  				%>
					  						<a onclick="hide('<%=i+"_"+j+"-"+k+"_"+m%>')"><img id="img<%=i+"_"+j+"-"+k+"_"+m%>" src="<%=path %>/img/NodeImg1.gif"/></a>
					  				<% 
					  					}else{
					  				%>
					  						<a onclick="hide('<%=i+"_"+j+"-"+k+"_"+m%>')"><img id="img<%=i+"_"+j+"-"+k+"_"+m%>" src="<%=path %>/img/NodeImg0.gif"/></a>
					  				<% 
					  					}
					  				%>
					  			...
					  			<%for(int n=0;n<rank5.size();n++){
						  			...
						  			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  										...
  										<%
  											yg6="a";
						  					for(int n_yg=0;n_yg<rank6.size();n_yg++){
						  						subject6_yg=new SubjectDTO();
						  						subject6_yg=(SubjectDTO)rank6.get(n_yg);
						  						if(subject6_yg.getParentSubjectCode().equals(subject5.getSubjectCode())){
						  							yg6="b";
						  						}
						  					}
						  					if(yg6.equals("b")){
						  				%>
						  						<a onclick="hide('<%=i+"_"+j+"-"+k+"_"+m+"-"+n%>')"><img id="img<%=i+"_"+j+"-"+k+"_"+m+"-"+n%>" src="<%=path %>/img/NodeImg1.gif"/></a>
						  				<% 
						  					}else{
						  				%>
						  						<a onclick="hide('<%=i+"_"+j+"-"+k+"_"+m+"-"+n%>')"><img id="img<%=i+"_"+j+"-"+k+"_"+m+"-"+n%>" src="<%=path %>/img/NodeImg0.gif"/></a>
						  				<% 
						  					}
						  				%>
						  			...
						  			<%for(int h=0;h<rank6.size();h++){
							  			...
							  			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  											...
  											<a onclick="hide('<%=i+"_"+j+"-"+k+"_"+m+"-"+n+"_"+h%>')"><img id="img<%=i+"_"+j+"-"+k+"_"+m+"-"+n+"_"+h%>" src="<%=path %>/img/NodeImg0.gif"/></a>
