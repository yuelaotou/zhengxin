...
function gotos(){
	window.location.href='overPayWindowPrinAC.do';
}
</script>
				...
				<table width="95%" border="0" cellspacing="0" cellpadding="3"
					...
					<tr valign="bottom">
						<td colspan="7" bgcolor="#FFFFFF" align="center" height="30">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<logic:notEmpty name="overPayDTO">
									<tr>
										<td width="17%" class="td1">
											扣款账号
										</td>
										<td width="33%" colspan="2">
											<html:text name="overPayDTO" property="loankouacc"styleClass="input3" readonly="true"/></td>
										<td width="17%" class="td1">
											合同编号
										</td>
										<td width="33%">
											<html:text name="overPayDTO" property="contractId"styleClass="input3" readonly="true"/></td>
									</tr>
									<tr>
										<td width="17%" class="td1">
											借款人姓名
										...
										<td width="33%" colspan="2">
											<html:text name="overPayDTO" property="borrowerName"styleClass="input3" readonly="true"/></td>
										<td width="17%" class="td1">
											证件类型
										</td>
										<td width="33%">
											<html:text name="overPayDTO" property="cardKindName"styleClass="input3" readonly="true"/></td>
									</tr>
									<tr>
										<td width="17%" class="td1">
											证件号码
										...
										<td width="33%" colspan="2">
											<html:text name="overPayDTO" property="cardNum"styleClass="input3" readonly="true"/></td>
										<td width="17%" class="td1">
											还款方式
										</td>
										<td width="33%">
											<html:text name="overPayDTO" property="loanModeName"styleClass="input3" readonly="true"/></td>
									</tr>
									<tr>
										<td width="17%" class="td1">
											挂账余额
										...
										<td width="33%" colspan="2">
											<html:text name="overPayDTO" property="ovaerLoanRepay"styleClass="input3" readonly="true"/></td>
										<td width="17%" class="td1">
											挂账金额
										</td>
										<td width="33%">
											<html:text name="overPayDTO" property="overpayMoney"styleClass="input3" readonly="true"/></td>
									</tr>
								</logic:notEmpty>
								<logic:empty name="overPayDTO">
									<tr>
