...
<div align="center"><br>
  ...
  <table width=641 border=0 cellpadding=0 cellspacing=0>
    <tr>
      <td colspan=4 height="32" class="font14" background="<%=path%>/img/search_1.jpg" style="PADDING-top: 8px"><b>月结</b>
      </td>
    </tr>
    <tr>
...
<input type="hidden" name="temp" value="0"></td>
        </tr>
      </table>
       ...
       <%j++;
        ...
        <tr id="tr<%=i%>" class="<%=strClass%>">     
			...
			<td >
			<html:multibox property="rowArray"  ><bean:write name="elements" property="collBankId"/>,<bean:write name="elements" property="collBankDate" /></html:multibox>
			</td>
			<td valign="top"><p><bean:write name="elements" property="collBankName" /></p></td>
			<td valign="top"><p><bean:write name="elements" property="collBankDate" /></p></td>
        </tr>
