  ...
  <tr> 
      ...
      <html:form action="/adjustAccountPopFindAC">
        ...
        <table border="0" width="95%" id="table1" cellspacing=1  cellpadding=3 align="center" >
          <tr> 
            <td width="13%"   class="td1">合同编号 </td>
            <td width="18%"  > 
              <html:text name="adjustAccountPopFindAF" property="adjustAccountPopFindDTO.contractId" styleClass="input3" onkeydown="enterNextFocus1();" maxlength="100"></html:text>
            </td>
