...
function loads(){
var count = "<%=request.getAttribute("massageinfo") %>";
	...
	<table width="95%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td class=td3>
				...
				<html:form action="/carryforwardTaFindAC" style="margin: 0">
					<table border="0" width="95%" id="table1" cellspacing=1
						...
						<tr>
							...
							<td class="td1" width="50%" algin="center" colspan="2">
							<p align="center">
				...
				<html:form action="/carryforwardTaMaintainAC.do" style="margin: 0">
				<html:hidden name="carryforwardShowAF" property="loanBankId"></html:hidden>
          ...
          <tr align="center" bgcolor="C4F0FF"> 
						...
						<logic:notEmpty name="carryforwardShowAF" property="list">
						<% int j=0;
			String strClass="";
		%>
							<logic:iterate name="carryforwardShowAF" property="list"
		...
		%>
						...
						<logic:empty name="carryforwardShowAF" property="list">
							<tr>
