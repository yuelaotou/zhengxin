...
<html>
  ...
  <script type="text/javascript">
	function load(){
	loginReg();
	document.forms(0).Cell1.openfile("<%=path%>/sysloan/accounthandle/report/clearaccountbalance_month.cll","");
	<%
	...
	%>	
		...
		//时间
		document.forms(0).Cell1.S(5,2,0,"<%=startDate.substring(0,4)%>年"+"<%=startDate.substring(4,6)%>月");
		//操作员
