...
<%@ page
	import="org.xpup.hafmis.sysloan.dataready.assistantorg.action.SurrogateShowAC"%>
...
<%
	...
	SurrogateShowAC.PAGINATION_KEY);
...
<html:form action="/surrogateMaintainAC">
    ...
    <td class=td3> 
      <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="35"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="22" bgcolor="#CCCCCC" align="center" width="167"><b class="font14">代理机构信息列表</b></td>
     ...
     <table width="95%" border="0" bgcolor="#76BEE9" cellspacing="1" cellpadding="3" align="center">
          <tr align="center" bgcolor="C4F0FF"> 
            ...
            <!-- 张列改  头 -->
			<a href="javascript:sort('assistantOrg.assistantOrgId')">代理机构名称</a>
          	<logic:equal name="pagination" property="orderBy" value="assistantOrg.assistantOrgId">
          	<!-- 张列改  尾 -->
            ...
            <td align="center" class=td2 > 代理机构地址</td>
            <td align="center" class=td2>
            ...
            <td align="center" class=td2 > 注册资金</td>
          </tr>
		...
		%>
          <tr id="tr<%=i%>" onclick='gotoClickpp("<%=i %>", idAF);' onMouseOver='this.style.background="#eaeaea"' onMouseOut='gotoColorpp("<%=i %>", idAF);' class="<%=strClass%>" onDblClick="">      
            ...
            <td><bean:write name="assorgAF" property="registerFund"/></td>
          </tr>
								...
								<tr>
									...
									<td align="right">
										<jsp:include page="../../../inc/pagination.jsp">
											<jsp:param name="url" value="surrogateShowAC.do" />
										</jsp:include>
									</td>
								</tr>
							</table>
