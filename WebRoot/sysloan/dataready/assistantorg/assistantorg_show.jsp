...
<%@ page
	import="org.xpup.hafmis.sysloan.dataready.assistantorg.action.AssistantorgShowAC"%>
...
<%
	...
	AssistantorgShowAC.PAGINATION_KEY);
...
<html:form action="/assistantorgMaintainAC">
      ...
      <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="35"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="22" bgcolor="#CCCCCC" align="center" width="167"><b class="font14">担保公司信息列表</b></td>
     ...
     <table width="95%" border="0" cellspacing="0" cellpadding="3" align="center">
      ...
      <table width="95%" border="0" bgcolor="#76BEE9" cellspacing="1" cellpadding="3" align="center">
          <tr align="center" bgcolor="C4F0FF"> 
			...
			<a href="javascript:sort('assistantOrg.assistantOrgName')">担保公司名称</a>
            ...
            <td align="center" class=td2 > 担保公司地址</td>
            <td align="center" class=td2>
            <!-- 张列改 头-->
								...
								<tr>
									...
									<td align="right">
										<jsp:include page="../../../inc/pagination.jsp">
											<jsp:param name="url" value="assistantorgShowAC.do" />
										</jsp:include>
									</td>
								</tr>
							</table>
