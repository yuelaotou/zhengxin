...
<script>
  ...
  function reportErrors(){
	...
	for(i=0;i<document.all.length;i++){
		...
		var assistantOrgName = document.forms[0].elements["assistantOrgName"].value.trim();
		if(assistantOrgName==null||assistantOrgName==""){
...
<html:form action="/surrogateAddUpdateAC">
          ...
          <td background="<%=path%>/img/table_bg_line.gif" align="right"> 
            <table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="234" class=font14 bgcolor="#FFFFFF" align="center" valign="bottom"><a href="#" class=a1>数据准备</a><font color="00B5DB">&gt;</font><a href="#" class=a1>代理机构维护</a></td>
  ...
  <tr> 
    <td class=td3> 
      <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="35"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="22" bgcolor="#CCCCCC" align="center" width="145"><b class="font14">代理机构新增</b></td>
      ...
      <table border="0" width="95%" id="table1" cellspacing=1  cellpadding=3 align="center" >
        <tr  > 
          <td  class="td1" width="14%"> 代理机构名称<font color="#FF0000">*</font></td>
          <td  class="td4"> 
        ...
        <td width="17%" class="td1"> 所属地区 </td>
          	<td> <html:select name="AF" property="arear" styleClass="input4" onkeydown="enterNextFocus1();">
        ...
        <td width="17%" class="td1" >  法人证件类型        </td>
          <td width="33%"> 
           <html:select name="AF" property="artfclprsnCardKind" styleClass="input4" onkeydown="enterNextFocus1();">
	        <html:option value=""></html:option>
			<html:optionsCollection property="map" name="AF" label="value" value="key" />
			</html:select></td>
				...
				<html:submit property="method" styleClass="buttona">
	             ...
	             <html:submit property="method" styleClass="buttona" onclick="javascript:history.back();">
           		...
           		<td width="33%" colspan="2"  > 
					<a href='javascript:excHz("<bean:write name="AF" property="photoUrl"/>");'>浏览证书</a>
			    </td>
        </tr>
      </table>
    </table>
