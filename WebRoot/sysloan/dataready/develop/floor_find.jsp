...
<%@page
	import="org.xpup.hafmis.sysloan.dataready.develop.action.FloorShowAC"%>
<%@ include file="/checkUrl.jsp"%>
<%
	String path = request.getContextPath();
	Object pagination = session
			.getAttribute(FloorShowAC.PAGINATION_KEY);
...
function loads(){
	...
	if(count!="0"){
		var flag = "<bean:write name="floorFindAF" property="flag" />";
		if(flag="1")
		{
			tr = "tr1";
		}
...
<body bgcolor="#FFFFFF" text="#000000"
	...
	<html:form method="post" action="/floorMainTainAC">
					...
					<table border="0" width="95%" id="table1" cellspacing=1
						...
						<tr>
							...
							<input type="hidden" name="developerId" id="developerId"
								value="<bean:write name="floorFindAF" property="floorDevelopInfoDTO.developerId"/>" />
							...
							<input type="hidden" name="developerName" id="developerName"
								value="<bean:write name="floorFindAF" property="floorDevelopInfoDTO.developerName"/>" />
						</tr>
						<!-- 
          <tr> 
            <td width="19%"   class="td1">国有土地使用权证编号</td>
            <td width="31%" > 
              <html:text name="floorFindAF" property="floorDevelopInfoDTO.landUseId" styleClass="input3" maxlength="50" readonly="true"></html:text>            </td>
            <td width="17%" class="td1" >商品房销售许可证号</td>
            <td width="33%"  > 
              <html:text name="floorFindAF" property="floorDevelopInfoDTO.salePermis" styleClass="input3" maxlength="50" readonly="true"></html:text>            </td>
          </tr>
           -->
						<tr>
						...
						<tr>
							...
							<td width="31%">
								<html:text name="floorFindAF"
									property="floorDevelopInfoDTO.developerPaybankB"
									styleClass="input3" maxlength="50" readonly="true"></html:text>
							</td>
							<td width="17%" class="td1">
								开户账号
							...
							<td width="33%">
								<html:text name="floorFindAF"
									property="floorDevelopInfoDTO.developerPaybankBAcc"
									styleClass="input3" maxlength="50" readonly="true"></html:text>
							</td>
						</tr>
						<tr>
							...
							<td width="33%">
								<html:text name="floorFindAF"
									property="floorDevelopInfoDTO.artfclprsn" styleClass="input3"
									maxlength="50" readonly="true"></html:text>
							</td>
						</tr>
						<tr>
							...
							<td width="31%">
								<html:text name="floorFindAF"
									property="floorDevelopInfoDTO.registerFundNumber"
									styleClass="input3" maxlength="50" readonly="true"></html:text>
							</td>
							...
							<logic:iterate id="floorListDTO" name="floorFindAF"
								...
								<logic:equal name="floorListDTO" property="floorFlag" value="1">
									<tr align="center" bgcolor="C4F0FF">
										...
										<td align="center" class=td2 colspan="5">
											<bean:write name="floorListDTO" property="floorAddress" />
										</td>
										 -->
									</tr>
								</logic:equal>
								<logic:equal name="floorListDTO" property="addressFlag"
									...
									<tr align="center" bgcolor="C4F0FF">
										...
										<td align="center" class=td2>
											<a href="javascript:sort('p6.floor_addr||\'-\'||p6.floor_num')">楼盘号</a>
											<logic:equal name="pagination" property="orderBy"
												value="p6.floor_addr||'-'||p6.floor_num">
								...
								<logic:notEqual name="floorListDTO" property="floorFlag"
									value="1">
									<tr id="tr<%=i%>"
										onclick='gotoSelect("<%=i%>",idAF);gettr("tr<%=i%>");'
										class="<%=strClass%>">
										<td>
											<input id="s<%=i%>" type="radio" name="id"
												value="<bean:write name="floorListDTO" property="floorId"/>"
												<logic:equal name="floorFindAF" property="flag" value="1">
													<%if(new Integer(1).equals(i)) out.print("checked"); %>
												</logic:equal>
												<logic:notEqual name="floorFindAF" property="flag" value="1">
									...
									<tr align="center">
										...
										<td align="right">
											<jsp:include page="../../../inc/pagination.jsp">
												<jsp:param name="url" value="floorShowAC.do" />
											</jsp:include>
										</td>
									</tr>
								</table>
