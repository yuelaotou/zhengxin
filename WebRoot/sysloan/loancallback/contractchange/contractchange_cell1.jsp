...
<script type="text/javascript">
	...
	loginReg();
	//加载模板文件..
	document.forms(0).Cell1.openfile("<%=path%>/sysloan/loancallback/report/contractchange1.cll","");
	...
	%>
		...
		document.forms(0).Cell1.S(19,11,0,"<%=contractchangeDTO.getAheadmoney() %>");//提前还款金额
