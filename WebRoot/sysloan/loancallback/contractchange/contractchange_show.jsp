...
<%@ page
	import="org.xpup.hafmis.sysloan.loancallback.contractchange.action.ContractchangeShowAC"%>
<%@ include file="/checkUrl.jsp"%>
<%
	String path = request.getContextPath();
	Object pagination = request.getSession(false).getAttribute(
			ContractchangeShowAC.PAGINATION_KEY);
...
if(a!=undefined){
	var status=document.getElementById("tr0").childNodes[6].innerHTML;	
	
	
	if("否"==status.trim()){
		document.all.item(s1).disabled=true;
	}else{
		var stat=document.getElementById("tr0").childNodes[7].innerHTML;	
		if("否"==stat.trim()){
		...
		if(document.getElementById(tr)!=null){
			var status=document.getElementById(tr).childNodes[6].innerHTML;	
				...
				if("否"==status.trim()){
					...
					var stat=document.getElementById(tr).childNodes[7].innerHTML;	
		if("否"==stat.trim()){
			document.all.item(s1).disabled=false;
		}else{
			document.all.item(s1).disabled=true;
...
<body bgcolor="#FFFFFF" text="#000000" onload="load();">
	<jsp:include page="../../../inc/sort.jsp">
		<jsp:param name="url" value="to_contractchangeShowAC.do" />
	</jsp:include>
	<table width="95%" border="0" cellspacing="0" cellpadding="0"
							...
							<table width="300" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="165" class=font14 bgcolor="#FFFFFF" align="center"
										valign="bottom">
										<a href="#" class=a1>贷款回收</a><font color="00B5DB">&gt;</font><a
											href="#" class=a1>合同变更</a>
									</td>
		...
		<tr>
			<td class=td3>
						...
						<td height="35">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="774" height="22" align="center"
				...
				<html:form action="/contractchangeFindAC.do">
					<table border="0" width="95%" id="table1" cellspacing=1
						...
						<tr>
							...
							<td width="24%">
								<html:text name="contractchangeAF" property="contractId"
							...
							<td colspan="3">
								<html:text name="contractchangeAF" property="borrowerName"
									onkeydown="enterNextFocus1();" styleClass="input3" />
							</td>
						</tr>
						<tr>
							...
							<td width="24%">
								<html:text name="contractchangeAF" property="cardNum"
									onkeydown="enterNextFocus1();" styleClass="input3" />
							</td>
							<td width="12%" class="td1">
								办理日期
							...
							<td width="10%">
								<html:text name="contractchangeAF" property="startDate"
									onkeydown="enterNextFocus1();" styleClass="input3"
									maxlength="8" />
							</td>
							...
							<td width="10%">
								<html:text name="contractchangeAF" property="endDate"
									onkeydown="enterNextFocus1();" styleClass="input3"
									maxlength="8" />
							</td>
						</tr>
					...
					<tr>
						<td height="35">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td height="22" bgcolor="#CCCCCC" align="center" width="131">
										<b class="font14">合同变更列表</b>
									</td>
									<td width="776" height="22" align="center"
										background="<%=request.getContextPath()%>/img/bg2.gif">
										&nbsp;
									</td>
								</tr>
				...
				<html:form action="/contractchangeMaintainAC.do" method="post"
					style="margin: 0">
					<table width="95%" border="0" bgcolor="#76BEE9" cellspacing="1"
						...
						<logic:notEmpty name="contractchangeAF" property="list">
							<%
									...
									String strClass = "";
							%>
							<logic:iterate id="element" name="contractchangeAF"
          ...
          <bean:write name="element" property="contractId" /></a></td>
									...
									<td>
										<bean:write name="element" property="new_term" />
									</td>
									<td>
									...
									<td>
										<bean:write name="element" property="mark_d" />
									</td>
									<td>
