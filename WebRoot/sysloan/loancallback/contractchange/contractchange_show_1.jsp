          ...
          <tr valign="bottom"> 
            <td  colspan="7" bgcolor="#FFFFFF" align="center" height="30"> 
              <table border="0" cellspacing="0" cellpadding="0">
                ...
                <logic:notEmpty name="contractchangeAF" property="list">
                 <td width="70"> 
                    <html:submit property="method" styleClass="buttonb"><bean:message key="button.auditing.pass"/></html:submit>
                  </td>
                </logic:notEmpty>
                <logic:empty name="contractchangeAF" property="list">
                 <td width="70"> 
                    <html:submit property="method" styleClass="buttonb" disabled="true"><bean:message key="button.auditing.pass"/></html:submit>
                  </td>
                </logic:empty>
