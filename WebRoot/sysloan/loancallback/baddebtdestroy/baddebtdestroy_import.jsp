...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
          ...
          <td background="<%=path%>/img/table_bg_line.gif" align="right"> 
            <table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="216" class=font14 bgcolor="#FFFFFF" align="center" valign="bottom"><font color="00B5DB">回收贷款&gt;呆账核销</font></td>
   ...
   <tr> 
    <td class=td3>
    <html:form action="/badDebtDestroyTaImportAC" style="margin: 0" enctype="multipart/form-data">
      <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="35"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table border="0" width="95%" id="table1" cellspacing=1  cellpadding=3 align="center" >
          <tr> 
            <td width="17%" class="td1"  >呆账核销导入:</td>
            <td width="38%"   > 
			      <html:file name="badDebtDestroyTaImportAF" property="theFile" size="50" maxlength="100" styleClass="input3"/>
...
<form action="badDebtDestroyTaShowAC.do" method="POST" name="Form1" id="Form1">
</form>
</body>
</html:html>	  