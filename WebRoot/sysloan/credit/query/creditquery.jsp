...
<%@ page
	import="org.xpup.hafmis.sysloan.credit.query.action.CreditQueryShowAC"%>

<%
	String path = request.getContextPath();
	Object pagination = request.getSession().getAttribute(CreditQueryShowAC.PAGINATION_KEY);
...
<body bgcolor="#FFFFFF" text="#000000" onload="reportErrors();">
	<jsp:include page="../../../inc/sort.jsp">
		<jsp:param name="url" value="creditQueryShowAC.do" />
	</jsp:include>
							...
							<table width="255" border="0" cellspacing="0" cellpadding="0"
								...
								<tr>
									...
									<td width="169" class=font14 bgcolor="#FFFFFF" align="center"
										valign="middle">
										<font color="00B5DB">征信系统&gt;上报查询</font>
									</td>
				...
				<table width="98%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align="center" valign="top" class=td3>
							...
							<html:form action="/creditQueryFindAC.do" method="post"
								style="margin: 0">
