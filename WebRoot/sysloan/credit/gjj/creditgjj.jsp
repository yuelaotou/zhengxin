							...
							<table width="255" border="0" cellspacing="0" cellpadding="0"
								...
								<tr>
									...
									<td width="169" class=font14 bgcolor="#FFFFFF" align="center"
										valign="middle">
										<font color="00B5DB">归集征信系统&gt;上报查询</font>
									</td>
							...
							<html:form action="/creditFindAC.do" method="post"
								...
								<table border="0" width="95%" id="table1" cellspacing=1
									...
									<tr>
										...
										<td width="33%">
											<html:select name="creditGjjAF" property="officeCode"
												styleClass="input3">
										...
										<td width="33%">
											<html:select name="creditGjjAF" property="collectionBank" styleClass="input4">
												<html:option value=""></html:option>
									...
									<tr>
										...
										<td width="33%">
											<html:text name="creditGjjAF" property="org_id"
										...
										<td width="33%">
											<html:text name="creditGjjAF" property="emp_id"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
									</tr>
									<tr>
										...
										<td width="33%">
											<html:text name="creditGjjAF" property="card_num"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
										<td width="17%" class="td1">
											缴至月份
										...
										<td width="33%">
											<html:text name="creditGjjAF" property="pay_month"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
									</tr>
									<tr>
										...
										<td width="33%">
											<html:select name="creditGjjAF" property="isloan"
												styleClass="input3">
												<html:option value=""></html:option>
										...
										<td width="33%">
											<html:select name="creditGjjAF" property="jiluzhuangtai"
												styleClass="input3">
												<html:option value=""></html:option>
									...
									<tr>
										...
										<td width="33%">
											<html:text name="creditGjjAF" property="shujutiquriqi"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
										<td width="17%" class="td1">
											报文生成日期
										...
										<td width="33%">
											<html:text name="creditGjjAF" property="baowenshengchengriqi"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
									</tr>
								</table>
