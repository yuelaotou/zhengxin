...
<%@ page
	import="org.xpup.hafmis.sysloan.loanapply.issuenotice.action.IssuenoticeTcShowAC"%>
<%
	String path = request.getContextPath();
	Object pagination = request.getSession().getAttribute(
			IssuenoticeTcShowAC.PAGINATION_KEY);
	...
	<table width="95%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td class=td3>
				...
				<html:form action="/issuenoticeTcFindAC.do" style="margin: 0">
					<table border="0" width="95%" id="table1" cellspacing=1
						...
						<tr>
							...
							<td width="21%">
								<html:select property="ischecked" styleClass="input4"
									name="issuenoticeTbAF" onkeydown="enterNextFocus1();">
									<option value=""></option>
									<option value="0">
										否
...
<%--								</html:select>--%>
				...
				<html:form action="/issuenoticeTcMaintainAC.do" style="margin: 0">
					<table width="95%" border="0" cellspacing="0" cellpadding="0"
						align="center">
						<tr>
							<td height="35">
						...
						<logic:notEmpty name="issuenoticeTbAF" property="list">
							...
							<logic:iterate id="e" name="issuenoticeTbAF" property="list"
								...
								<tr id="tr<%=i%>" 
									class="<%=strClass%>">
									<td>
										<input id="settNum" type="checkbox" name="settNum" onclick="saveId(this);" value="<bean:write name="e" property="contractId" />">
												...
												<tr>
													...
													<td align="right">
														<jsp:include page="../../../inc/pagination.jsp">
															<jsp:param name="url" value="issuenoticeTcShowAC.do" />
														</jsp:include>
													</td>
												</tr>
											</table>
