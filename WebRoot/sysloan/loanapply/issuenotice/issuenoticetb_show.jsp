...
<%@ page
	import="org.xpup.hafmis.sysloan.loanapply.issuenotice.action.IssuenoticeTbShowAC"%>
<%
	String path = request.getContextPath();
	Object pagination = request.getSession().getAttribute(
			IssuenoticeTbShowAC.PAGINATION_KEY);
...
function reportErrors() {
	...
	if(count!=0){
		var a=document.getElementById(tr).childNodes[8].innerHTML.trim();
		var print=document.getElementById(tr).childNodes[10].innerHTML.trim();	
		if(a == "打印借据"){
			if(print=="否"){
		...
		if(document.all.isDelete.value.trim()=="1"){
			var x=confirm("是否确认删除此记录!");
	 		if(x)
				document.location="issuenoticeTbDeleteAC.do";
	    	return false;
	  	}
	}	
}
function isPrint(){
	return confirm("如果您打印了借据,您将不可以进行修改\r是否继续!");
}
function gettr(tr){
	var a=document.getElementById(tr).childNodes[8].innerHTML.trim();
	var print=document.getElementById(tr).childNodes[10].innerHTML.trim();
	...
	<table width="95%" border="0" cellspacing="0" cellpadding="0"
							...
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="112" height="37"
										...
										<a href="<%=path%>/sysloan/issuenoticeTaForwardAC.do" class=a2>下达发放通知书</a>
									</td>
									<td width="112" height="37"
		...
		<tr>
			<td class=td3>
				...
				<html:form action="/issuenoticeTbFindAC.do" style="margin: 0">
					<table border="0" width="95%" id="table1" cellspacing=1
						cellpadding=0 align="center">
						<tr>
							<html:hidden name="issuenoticeTbAF" property="isDelete" />
						...
						<tr>
							...
							<td width="21%">
								<html:select property="contractSt" styleClass="input4"
									name="issuenoticeTbAF" onkeydown="enterNextFocus1();">
									<option value=""></option>
									<option value="9">
										下达发放通知书
				...
				<html:form action="/issuenoticeTbMaintainAC.do" style="margin: 0">
					<table width="95%" border="0" cellspacing="0" cellpadding="0"
						align="center">
						<tr>
							<td height="35">
						...
						<logic:notEmpty name="issuenoticeTbAF" property="list">
							...
							<logic:iterate id="e" name="issuenoticeTbAF" property="list"
								...
								<tr id="tr<%=i%>"
									...
									<td>
										<a href="#"
											onclick="window.open('<%=path%>/sysloan/issuenoticeTaShowAC.do?contractId=<bean:write name="e" property="contractId" />','window','height=400,width=800,top='+(window.screen.availHeight-400)/2+',left='+(window.screen.availWidth-800)/2+',scrollbars=yes,location=no,status=no');">
											<bean:write name="e" property="borrowerName" /> </a>
									</td>
									<td>
									...
									<td>
										<bean:write name="e" property="ischecked" />
									</td>
								</tr>
												...
												<tr>
													...
													<td align="right">
														<jsp:include page="../../../inc/pagination.jsp">
															<jsp:param name="url" value="issuenoticeTbShowAC.do" />
														</jsp:include>
													</td>
												</tr>
											</table>
