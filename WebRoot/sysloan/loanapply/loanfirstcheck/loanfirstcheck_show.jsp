...
<%@ page
	import="org.xpup.hafmis.sysloan.loanapply.loanfirstcheck.action.*"%>

<%
	String path = request.getContextPath();
	Object pagination = request.getSession(false).getAttribute(
			LoanFirstCheckShowAC.PAGINATION_KEY);
...
function loads(){
	for(i=0;i<document.all.length;i++){
		if(document.all.item(i).type=="submit"){
			if(document.all.item(i).value=="初审通过"){
				s1=i;
			}
			if(document.all.item(i).value=="撤消初审"){
				s2=i;
			}
...
<body bgcolor="#FFFFFF" text="#000000" onload="loads(); reportErrors();">
	...
	<jsp:include page="../../../inc/sort.jsp">
		<jsp:param name="url" value="loanCheckFirstShowAC.do" />
	</jsp:include>
							...
							<table width="255" border="0" cellspacing="0" cellpadding="0"
								...
								<tr>
									...
									<td width="169" class=font14 bgcolor="#FFFFFF" align="center"
										valign="middle">
										<font color="00B5DB">申请贷款&gt;贷款初审</font>
									</td>
				...
				<table width="98%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td valign="top" class=td3>
							...
							<html:form action="/loanFirstCheckFindAC.do" method="post"
								style="margin: 0">
								<table border="0" width="95%" id="table1" cellspacing=1
									...
									<tr>
										...
										<td width="21%" colspan="3">
											<html:text name="loanFirstCheckShowAF" property="contractId"
										...
										<td width="21%">
											<html:select name="loanFirstCheckShowAF"
												property="officeCode" styleClass="input3"
									...
									<tr>
										...
										<td width="21%" colspan="3">
											<html:text name="loanFirstCheckShowAF"
												property="borrowerName" styleClass="input3"
												onkeydown="enterNextFocus1();" />
										</td>
										<td width="11%" class="td1">
											证件号码
										...
										<td width="21%">
											<html:text name="loanFirstCheckShowAF" property="cardNum"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
									</tr>
									<tr>
										...
										<td width="21%" colspan="3">
											<html:text name="loanFirstCheckShowAF" property="orgName"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
										<td width="11%" class="td1">
											合同状态
										...
										<td width="21%">
											<html:select name="loanFirstCheckShowAF"
												property="contractSt" styleClass="input3"
												onkeydown="enterNextFocus1();">
												<html:option value=""></html:option>
												<html:optionsCollection property="contractStMap"
													name="loanFirstCheckShowAF" label="value" value="key" />
											</html:select>
										</td>
									</tr>
									<tr>
										...
										<td width="10%">
											<html:text name="loanFirstCheckShowAF" property="opTimeSt"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
										<td width="1%">
											至
										...
										<td width="10%">
											<html:text name="loanFirstCheckShowAF" property="opTimeEnd"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
										<td width="11%" class="td1">
											购房类型
										...
										<td width="21%">
											<html:select name="loanFirstCheckShowAF" property="houseType"
												styleClass="input3" onkeydown="enterNextFocus1();">
												<html:option value=""></html:option>
								...
								<table width="95%" border="0" cellspacing="0" cellpadding="0"
									...
									<tr>
										<td class=h4>
											...
											<u>：<bean:write name="loanFirstCheckShowAF"
													property="housePriceTotal" /> </u>借款金额（万元）
											<u>：<bean:write name="loanFirstCheckShowAF"
													property="loanMoneyTotal" /> </u> 面积
											<u>：<bean:write name="loanFirstCheckShowAF"
													property="houseAreaTotal" /> </u>
										</td>
									</tr>
								</table>
							</html:form>
							...
							<html:form action="/loanFirstCheckMaintainAC.do" method="post"
								style="margin: 0">
								...
								<table width="95%" border="0" bgcolor="#76BEE9" cellspacing="1"
									...
									<tr align="center" bgcolor="C4F0FF">
										...
										<td align="center" class=td2>
											<a href="javascript:sort('p115.loan_money')">借款金额（元）</a>
											<logic:equal name="pagination" property="orderBy"
									...
									<logic:notEmpty name="loanFirstCheckShowAF" property="list">

										<%
												int j = 0;
												String strClass = "";
										%>
										<logic:iterate name="loanFirstCheckShowAF" property="list"
											...
											<tr align="left" id="tr<%=i%>" class="<%=strClass%>">
												...
												<td>
													<bean:write name="element" property="houseAdd" />
												</td>
												<td>
									...
									<logic:empty name="loanFirstCheckShowAF" property="list">
										<tr>
												...
												<tr align="center">
													...
													<td align="right">
														<jsp:include page="/inc/pagination.jsp">
															<jsp:param name="url" value="loanFirstCheckShowAC.do" />
														</jsp:include>
													</td>
												</tr>
											</table>
												...
												<tr>
													<td width="70">
														<html:submit property="method" styleClass="buttona"
															...
															<bean:message key="button.firstcheck.pass" />
														</html:submit>
													</td>
													<td width="70">
														<html:submit property="method" styleClass="buttona"
													...
													<td width="70">
														<html:submit property="method" styleClass="buttona"
															onclick="return quash(this);">
															<bean:message key="button.firstcheck.quash" />
														</html:submit>
													</td>
												</tr>
											</table>
