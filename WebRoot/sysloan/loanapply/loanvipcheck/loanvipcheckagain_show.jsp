...
function loads(){
	...
	for(i=0;i<document.all.length;i++){
		if(document.all.item(i).type=="submit"){
			if(document.all.item(i).value=="拨款审批通过"){
				s1=i;
			}
			if(document.all.item(i).value=="审批不通过"){
				s2=i;
			}
			if(document.all.item(i).value=="撤消拨款审批"){
				s3=i;
			}
							...
							<table width="255" border="0" cellspacing="0" cellpadding="0"
								...
								<tr>
									...
									<td width="169" class=font14 bgcolor="#FFFFFF" align="center"
										valign="middle">
										<font color="00B5DB">申请贷款&gt;拨款审批</font>
									</td>
												...
												<tr>
													<td width="70">
														<html:submit property="method" styleClass="buttonb"
															...
															<bean:message key="button.approvalagain.pass" />
														</html:submit>
													</td>
													<td width="70">
														<html:submit property="method" styleClass="buttonb"
													...
													<td width="70">
														<html:submit property="method" styleClass="buttonb"
															onclick="return check(this);">
															<bean:message key="button.approvalagain.quash" />
														</html:submit>
													</td>
													<td width="70">
														<html:submit property="method" styleClass="buttona">
