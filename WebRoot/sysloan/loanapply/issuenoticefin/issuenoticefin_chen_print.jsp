...
<%
   ...
   String lastPerson=(String)request.getAttribute("lastPerson");
   String vipchkPerson=(String)request.getAttribute("vipchkPerson");
   String finchkPerson=(String)request.getAttribute("finchkPerson");
 %>
<html>
<head>
		...
		bizDateYear="<%=bizdate.substring(0,4)%>";		
			...
			for(k = 0 ; k < totalLine; k++){
				...
				if(pageCurrent==0){
					...
					document.forms(0).Cell1.S(19,9,0,bizDateYear);
					document.forms(0).Cell1.S(25,9,0,bizDateMonth);
					document.forms(0).Cell1.S(31,9,0,bizDate);
					document.forms(0).Cell1.S(49,9,0,contractId[k]);
					...
					document.forms(0).Cell1.S(8,20,0,orgname[k]);
					document.forms(0).Cell1.S(32,20,0,orgtel[k]);
					document.forms(0).Cell1.S(52,20,0,houseaddr[k]);
					document.forms(0).Cell1.S(8,23,0,housearea[k]);
					document.forms(0).Cell1.S(32,23,0,housetotalprice[k]);
					document.forms(0).Cell1.S(60,23,0,monthinterest[k]);
					document.forms(0).Cell1.S(8,26,0,house[k]);
					document.forms(0).Cell1.S(52,26,0,sellerBank[k]+"-"+sellerBankAcc[k]);
					document.forms(0).Cell1.S(8,29,0,loadLimitTime[k]+"(月)");
					document.forms(0).Cell1.S(60,29,0,firstloanmoney[k]);
					document.forms(0).Cell1.S(1,40,0,bizDateYear);
					document.forms(0).Cell1.S(8,40,0,bizDateMonth);
					document.forms(0).Cell1.S(14,40,0,bizDate);
					document.forms(0).Cell1.S(25,40,0,redatepsn[k]);
					document.forms(0).Cell1.S(40,40,0,chkagainpsn[k]);
					...
					document.forms(0).Cell1.S(8,73,0,housearea[k]);
