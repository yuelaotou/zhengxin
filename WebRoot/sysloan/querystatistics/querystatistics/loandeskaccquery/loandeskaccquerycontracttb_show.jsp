...
for(i=0;i<document.all.length;i++){
	 ...
	 var contractId=document.loanapplytbnewAF.elements["contractId"].value
	if(contractId==""){
	document.all.item(s1).disabled="true";
	}
	tr="tr0";
	var count=document.loanapplytbnewAF.elements["count"].value
	if(count!="0"){
...
function executeAjaxIn(trindex) {
	...
	var queryString = "loanDeskaccQueryContractInfoTbFindEmpInfoAAC.do?";
								...
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="112" height="37"
											...
											<a
												href="<%=path%>/sysloan/loanDeskaccQueryContractInfoTaShowAC.do"
												class=a2>借款人信息</a>
										</td>
										<td width="112" height="37"
											...
											<a
												href="<%=path%>/sysloan/loanDeskaccQueryContractInfoTbShowAC.do"
												class=a2>辅助借款人信息</a>
										</td>
										<td width="112" height="37"
											background="<%=path%>/img/buttong.gif" align="center"
											style="PADDING-top: 7px" valign="top">
											<a
												href="<%=path%>/sysloan/loanDeskaccQueryContractInfoTcShowAC.do"
												class=a2>购房信息</a>
										</td>
										<td width="112" height="37"
											background="<%=path%>/img/buttong.gif" align="center"
											style="PADDING-top: 7px" valign="top">
											<a
												href="<%=path%>/sysloan/loanDeskaccQueryContractInfoTdShowAC.do"
												class=a2>借款人额度信息</a>
										</td>
							...
							<td valign="top" class=td3>
								<html:form action="loancontractqueryTbPrintAC">
												...
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														<td height="22" bgcolor="#CCCCCC" align="center"
															width="209">
															<b class="font14">辅 助 借 款 人 基 本 信 息</b>
														</td>
									...
									<table border="0" width="95%" id="table1" cellspacing=1
										...
										<tr>
											<html:hidden property="count" name="loanapplytbnewAF" />
											<td class=td1 width="12%">
												职工编号
											</td>
											<td class="td4">
											...
											<td class="td4" width="30%">
												<html:text property="relation" name="loanapplytbnewAF"
													styleClass="input3" readonly="true" />
											</td>
										</tr>
										<tr>
											...
											<td height="35">
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														<td height="22" bgcolor="#CCCCCC" align="center"
															width="279">
															<b class="font14">辅 助 借 款 人 公 积 金 归 集 信 息</b>
														</td>
														<td height="22" background="<%=path%>/img/bg2.gif"
											...
											<table border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td width="110" align="center" valign="middle">
														<html:submit styleClass="buttonc"
