...
<%@ page
	import="org.xpup.hafmis.sysloan.querystatistics.loanaccountquery.particulargl.action.ParticularglTcShowAC"%>
<%
			Object pagination = request.getSession(false).getAttribute(ParticularglTcShowAC.PAGINATION_KEY);
...
function gotoback(){
alert(1);
loaction='/<%=path%>sysloan/particularglTbShowAC.do';
}
</script>
													...
													<tr class="td1">
														...
														<td align="right">
															<jsp:include page="../../../../inc/pagination.jsp">
																<jsp:param name="url" value="particularglTcShowAC.do"/>
															</jsp:include>
							...
							<tr valign="bottom">
								<td colspan="7" bgcolor="#FFFFFF" align="center" height="30">
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="70">
												<html:submit property="method" styleClass="buttona" onclick="location.href='particularglTcPrintAC.do'">
													<bean:message key="button.print" />
												</html:submit>
												
											</td>
											<td width="70" align="center" valign="middle">
												 <input type="button" name="Submit4" value="返回" class="buttona" onclick="location.href='particularglTbShowAC.do'">
											</td>
										</tr>
									</table>
								</td>
