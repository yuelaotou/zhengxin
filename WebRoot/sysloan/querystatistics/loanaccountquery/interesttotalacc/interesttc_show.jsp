...
<%@ page
	import="org.xpup.hafmis.sysloan.querystatistics.loanaccountquery.interesttotalacc.action.InterestTcShowAC"%>
<%
	String path = request.getContextPath();
	Object pagination = request.getSession(false).getAttribute(
			InterestTcShowAC.PAGINATION_KEY);
...
function check(trindex){
	var bankId = document.interestTaAF.elements["loanBankId"].value.trim();
	var year = document.interestTaAF.elements["startYear"].value.trim();
	var month = document.interestTaAF.elements["month"].value.trim();
	if(bankId == ""){
		alert("请选择银行");
		return false;
	}
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td class=td3>
				...
				<html:form action="/interestTcFindAC.do" style="margin:0">
					<table border="0" width="95%" cellspacing=1 cellpadding=0
						...
						<tr>
							...
							<td width="16%">
								<html:text name="interestTaAF" property="month"
									onkeydown="enterNextFocus1();" styleClass="input3" />
							</td>
							<td width="3%" align="center">
								月
								...
								<tr>
									...
									<td align="right">
										<jsp:include page="../../../../inc/pagination.jsp">
											<jsp:param name="url" value="interestTcShowAC.do" />
										</jsp:include>
									</td>
								</tr>
