...
<%
	...
	Object pagination = request.getSession(false).getAttribute(
			PrincipalTaShowAC.PAGINATION_KEY);
...
function viewMonthAcc(trindex){
	...
	var id = document.getElementById(tr).childNodes[12].innerHTML.trim();
	location="principalTbForwardURLAC.do?loanBankId="+id+"&year="+year;
}
</script>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td class=td3>
				...
				<html:form action="/principalTaFindAC.do" style="margin:0">
					<table border="0" width="95%" cellspacing=1 cellpadding=0
						...
						<tr>
							...
							<td width="17%">
								<html:text name="principalTaAF" property="endYear"
									onkeydown="enterNextFocus1();" styleClass="input3" />
							</td>
						</tr>
					</table>
