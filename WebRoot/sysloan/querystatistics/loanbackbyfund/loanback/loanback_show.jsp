...
<%@ page
	import="org.xpup.hafmis.sysloan.querystatistics.loanbackbyfund.loanback.action.LoanBackShowAC"%>
...
<body bgcolor="#FFFFFF" text="#000000">
	<jsp:include page="../../../../inc/sort.jsp">
		<jsp:param name="url" value="loanBackShowAC.do" />
	</jsp:include>
				...
				<table width="98%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td valign="top" class=td3>
							...
							<html:form action="/loanBackFindAC" style="margin: 0">
								<table border="0" width="95%" id="table1" cellspacing=1
									...
									<tr>
										...
										<td width="33%" colspan="3">
											<html:select name="loanBackAF" property="office"
										...
										<td width="33%">
											<html:select name="loanBackAF" property="loanBankName"
									...
									<tr>
										...
										<td width="33%" align="center" colspan="3">
											<html:text name="loanBackAF" property="contractId"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
										<td width="17%" class="td1">
											姓名
										...
										<td align="center">
											<html:text name="loanBackAF" property="borrowerName"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
									</tr>
									<tr>
										...
										<td width="33%" align="center" colspan="3">
											<html:text name="loanBackAF" property="empId"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
										<td width="17%" class="td1">
											单位名称
										...
										<td align="center">
											<html:text name="loanBackAF" property="orgName"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
									</tr>
									<tr>
										...
										<td width="33%" align="center" colspan="3">
											<html:text name="loanBackAF" property="orgId"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
										<td width="17%" class="td1">
											身份证号
										...
										<td align="center">
											<html:text name="loanBackAF" property="borrowerCardNum"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
									</tr>
									<tr>
										...
										<td width="15%">
											<html:text name="loanBackAF" property="beginBizDate"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
										...
										<td width="15%">
											<html:text name="loanBackAF" property="endBizDate"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
										<td width="15%" class="td1">
											批次号
										...
										<td width="33%" align="center" colspan="3">
											<html:text name="loanBackAF" property="noteNum"
												styleClass="input3" onkeydown="enterNextFocus1();" />
										</td>
									</tr>
								</table>
								...
								<table width="95%" border="0" cellspacing="0" cellpadding="0"
									...
									<tr>
										<td class=h4>
											合计：本金总计
											<u>：<bean:write name="loanBackAF" property="data_1"  format="#,##0.00"/> </u>
											利息总计
											<u>：<bean:write name="loanBackAF" property="data_2"  format="#,##0.00"/> </u>
											逾期息总计
											<u>：<bean:write name="loanBackAF" property="data_3"  format="#,##0.00"/> </u>
											总额合计
											<u>：<bean:write name="loanBackAF" property="data_4"  format="#,##0.00"/> </u>
										</td>
									</tr>
								</table>
							</html:form>
							...
							<html:form action="/loanBackMaintainAC" style="margin: 0">
								...
								<table width="95%" border="0" bgcolor="#76BEE9" cellspacing="1"
									...
									<logic:notEmpty name="loanBackAF" property="list">
										<%
												int j = 0;
												String strClass = "";
										%>
										<logic:iterate name="loanBackAF" property="list" id="element"
											indexId="i">
											<%
														j++;
														if (j % 2 == 0) {
											...
											<tr align="left" id="tr<%=i%>"
												...
												<td>
													<p>
														<bean:write name="element" property="benjin" />
													</p>
												</td>
												...
												<td>
													<p>
														<bean:write name="element" property="sum" />
													</p>
												</td>
												<td>
													<p>
												...
												<td>
													<p>
														<bean:write name="element" property="kouPersonName" />
													</p>
												</td>
												<td>
													<p>
									...
									<logic:empty name="loanBackAF" property="list">
										<tr>
							...
							<form action="loanBackShowAC.do" name="Form1"></form>
						</td>
					</tr>
				</table>
			</td>
