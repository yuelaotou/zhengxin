...
function sure(){
	...
	var timeSt = document.forms[0].elements["timeSt"].value;
	var timeEnd = document.forms[0].elements["timeEnd"].value;	
	var contractIdEnd = document.forms[0].elements["contractIdEnd"].value;	
	if(timeSt==""){
		alert('请输入开始发生日期');
		return false;
	}else{
	...
	window.opener.document.URL="collFnComparisonOrgAccountPrintAC.do?contractId="+contractId+"&timeSt="+timeSt+"&timeSt="+timeSt+"&timeEnd="+timeEnd+"&contractIdEnd="+contractIdEnd;
	window.close();
}
</script>
<body bgcolor="#FFFFFF" text="#000000"
	onContextmenu="return false">
	<html:form action="/checkQueryPlFnTBFindAC.do">
						...
						<tr>
							...
							<td width="15%" colspan="3">
								<html:text name="collFnComparisonOrgAccountShowAF"
									property="contractId" styleClass="input3" maxlength="50"
							...
							<td width="15%">
								<html:text name="collFnComparisonOrgAccountShowAF"
									property="contractIdEnd" styleClass="input3" maxlength="50"
									onkeydown="enterNextFocus1();"></html:text>
							</td>
							</tr>
							<tr>
