...
function findInfo(){
	var id=getCheckId();
	location.href='<%=path%>/sysloan/loancontractqueryTfShowAC.do?pl121IdWY='+id;
	
}



function gototfPrint(){
location='loancontractqueryTfPrintAC.do';
}
</script>
												...
												<table border="0" cellspacing="0" cellpadding="0">
													...
													<logic:empty name="theEndorsecontractTbAF" property="list">
														<td width="73" align="center" valign="middle">
															<html:submit styleClass="buttona" onclick="gototfPrint();" disabled="true">
														...
														<logic:notEmpty name="theEndorsecontractTbAF" property="list">
														<td width="73" align="center" valign="middle">
															<html:submit styleClass="buttona" onclick="gototfPrint();">
																<bean:message key="button.print" />
															</html:submit>
														</td>
														</logic:notEmpty>
