...
<table cellspacing="1" class="basicinfo" >
  <thead>
    <tr>
      <th colspan="4">用户角色设置</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th width="25%">登录名称:</th>
      <td width="25%"><logic:notEmpty name="employee">
    ...
    <tr>
      <td colspan="4" style="text-align:center;"><table width="460px">
          <tr>
            <td width="200">可用角色</td>
            <td></td>
            <td>已选角色</td>
          </tr>
          <tr>
            <td><select name="available" size="10" class="text" multiple="multiple">
                <logic:iterate id="role" name="available" indexId="index">
            ...
            <td width="200px"><select name="selected" size="10" class="text" multiple="multiple">               
                <logic:iterate id="role" name="selected" indexId="index">
                  <option value="<bean:write name="role" property="id"/>" ><bean:write name="role" property="name"/> </option>
                </logic:iterate>
              </select>
            </td>
...
<html:form action="/assign_roles_to_user">
  <input type="hidden" name="idString" value="" />
  <input type="hidden" name="itemId" value="<bean:write name="employee" property="id" />" />
</html:form>
</body>
</html>
