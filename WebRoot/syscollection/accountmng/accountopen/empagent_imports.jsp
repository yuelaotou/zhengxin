...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
          ...
          <td background="<%=path%>/img/table_bg_line.gif" align="right"> 
            <table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="216" class=font14 bgcolor="#FFFFFF" align="center" valign="bottom"><font color="00B5DB">开户销户&gt;职工修改导入</font></td>
   ...
   <tr> 
    <td class=td3>
    <html:form action="/empAgentImportAC" style="margin: 0" enctype="multipart/form-data">
      <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="35"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table border="0" width="95%" id="table1" cellspacing=1  cellpadding=3 align="center" >
          <tr> 
            <td width="17%" class="td1">职工修改导入:</td>
            <td width="38%"   > 
        ...
        <tr valign="bottom"> 
          <td  colspan="7" bgcolor="#FFFFFF" align="center" height="30"> 
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="90"><html:submit styleClass="buttonb" onclick="return on_Submit(this)"><bean:message key="button.empAgent.import"/></html:submit></td>    
...
<form action="../accountopen/employee_kh_show.do" method="POST" name="Form1" id="Form1">
</form>
</body>
</html>
