...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
          ...
          <td background="<%=path%>/img/table_bg_line.gif" align="right"> 
            <table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="216" class=font14 bgcolor="#FFFFFF" align="center" valign="bottom"><font color="00B5DB">开户销户&gt;办理开户</font></td>
   ...
   <tr> 
    <td class=td3>
    <html:form action="/empopenImportAC" style="margin: 0" enctype="multipart/form-data">
      <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="35"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table border="0" width="95%" id="table1" cellspacing=1  cellpadding=3 align="center" >
          <tr> 
            <td width="17%" class="td1"  >职工开户导入:</td>
            <td width="38%"   > 
            ...
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><html:submit styleClass="buttona" onclick="return on_Submit(this)"><bean:message key="button.imports"/></html:submit></td>    
			  	<td><html:submit styleClass="buttona" onclick="return goBack()"><bean:message key="button.back"/></html:submit></td>    
			  </tr>
            </table>    
      	  </td>
  		</tr>
