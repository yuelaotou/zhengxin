...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
           ...
           <td background="<%=path %>/img/table_bg_line.gif" align="right"> 
            <table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="148" class=font14 bgcolor="#FFFFFF" align="center" valign="bottom"><font color="00B5DB">变更业务&gt;人员变更</font></td>
  ...
  <tr> 
    <td class=td3>
   		 	...
   		 	<html:form  action="/saveEmpchoAC.do" style="margin: 0">
      ...
      <table width="95%" border="0" cellspacing="0" cellpadding="3" align="center">
		...
		<logic:notEmpty name="empChoIdAF" property="list" >
		<logic:iterate name="empChoIdAF" property="list"  id="element" indexId="i">
	
        <tr id="tr<%=i%>" onclick='gotoClick("tr<%=i %>","s<%=i%>",empChoIdAF);' onMouseOver='this.style.background="#eaeaea"'  onMouseOut='gotoColor("tr<%=i %>","s<%=i %>",empChoIdAF);' class=td4  onDblClick=""> 
