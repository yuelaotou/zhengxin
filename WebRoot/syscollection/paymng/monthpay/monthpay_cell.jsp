...
<html>
  ...
  <script type="text/javascript">
	...
	%>
		...
		document.forms(0).Cell1.S(1,17,0,"<%=monthpayJYAF.getInceptMonth()%>"+"-"+"<%=monthpayJYAF.getPayMonth()%>");
		document.forms(0).Cell1.S(12,17,0,"<%=monthpayJYAF.getInceptMonth()%>"+"-"+"<%=monthpayJYAF.getPayMonth()%>");
		document.forms(0).Cell1.S(28,17,0,"<%=monthpayJYAF.getInceptMonth()%>"+"-"+"<%=monthpayJYAF.getPayMonth()%>");
        ...
        document.forms(0).Cell1.S(38,8,0,"  <%=monthpayJYAF.getPayment_bank_name()%>");
         ...
         document.forms(0).Cell1.S(1,20,0,"<%=monthpayJYAF.getPersonCounts()%>");
         document.forms(0).Cell1.S(4,20,0,"<%=monthpayJYAF.getPayMoney()%>");
         
         document.forms(0).Cell1.S(12,20,0,"<%=monthpayJYAF.getPersonCountsAdd()%>");
         document.forms(0).Cell1.S(18,20,0,"<%=monthpayJYAF.getPayMoneyAdd()%>");
        
          document.forms(0).Cell1.S(28,20,0,"<%=monthpayJYAF.getPersonCountsLess()%>");
          document.forms(0).Cell1.S(34,20,0,"<%=monthpayJYAF.getPayMoneyLess()%>");
