...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
          ...
          <td background="<%=path%>/img/table_bg_line.gif" align="right"> 
            <table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="216" class=font14 bgcolor="#FFFFFF" align="center" valign="bottom"><a href="#" class=a1>缴存管理</a><font color="00B5DB">&gt;</font><a href="#" class=a1>个人补缴</a></td>
   ...
   <tr> 
    <td class=td3>
    <html:form action="/personAddPayTaImportAC" style="margin: 0" enctype="multipart/form-data">
      <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="35"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table border="0" width="95%" id="table1" cellspacing=1  cellpadding=3 align="center" >
          ...
          <tr> 
            <td width="17%" class="td1"  >个人补缴导入:</td>
            <td width="38%"   > 
			      <html:file name="personAddPayImportAF" property="theFile" size="50" maxlength="100" styleClass="input3"/>
			      <html:hidden property="url"/>
			      <html:hidden name="personAddPayImportAF" property="orgId"/>
			      <html:hidden name="personAddPayImportAF" property="orgName"/>
			      <html:hidden name="personAddPayImportAF" property="noteNum"/>
			      <html:hidden name="personAddPayImportAF" property="payKind"/>
			      <html:hidden name="personAddPayImportAF" property="payWay"/>
			      <html:hidden name="personAddPayImportAF" property="payment_orgname"/>
            </td>
            <td  >&nbsp;</td>
          </tr>
        </table>
...
<form action="personAddPayTaShowAC.do" method="POST" name="Form1" id="Form1">
</form>
</body>
</html:html>	  