...
function goClose() {
  window.opener.document.URL="<%=path%>/syscollection/paymng/orgaddpay/orgaddpayExportAC.do?tatol="+document.chgPayExport.elements["tatol"].value+"&empIds="+document.chgPayExport.elements["empIds"].value+"&empNames="+document.chgPayExport.elements["empNames"].value
...
function reportErrors() {
	...
	<body bgcolor="#FFFFFF" text="#000000" onload="reportErrors();"
		...
		<form action="<%=path%>/syscollection/paymng/orgaddpay/orgaddpayExportAC.do"
