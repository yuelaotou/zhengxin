...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
          ...
          <td background="<%=path%>/img/table_bg_line.gif" align="right"> 
            <table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="216" class=font14 bgcolor="#FFFFFF" align="center" valign="bottom"><a href="#" class=a1>转入登记</a><font color="00B5DB">&gt;</font><a href="#" class=a1>人员变更</a></td>
   ...
   <tr> 
    <td class=td3>
    <html:form action="/traninTaImportAC" style="margin: 0" enctype="multipart/form-data">
    <html:hidden name="traninImportAF" property="inOrgId"></html:hidden>
      <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="35"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<form action="/hafmis/syscollection/tranmng/tranin/showTraninListAC.do" method="POST" name="Form1" id="Form1">
</form>
</body>
</html:html>	