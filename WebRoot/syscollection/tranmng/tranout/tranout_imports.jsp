...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
          ...
          <td background="<%=path%>/img/table_bg_line.gif" align="right"> 
            <table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="216" class=font14 bgcolor="#FFFFFF" align="center" valign="bottom">转入转出<font color="00B5DB">&gt;</font>办理转出</td>
   ...
   <tr> 
    <td class=td3>
    <html:form action="/tranTaImportAC" style="margin: 0" enctype="multipart/form-data">
      <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="35"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table border="0" width="95%" id="table1" cellspacing=1  cellpadding=3 align="center" >
          <tr> 
            <td width="17%" class="td1"  >办理转出导入:</td>
            <td width="38%"   > 
		   <html:file name="tranImportTaAF" property="theFile"  styleClass="input3"/>
      <html:hidden property="url"/>
      <html:hidden name="tranImportTaAF" property="orgOutid"/>
      <html:hidden name="tranImportTaAF" property="orgOutName"/>
      <html:hidden name="tranImportTaAF" property="orgInid"/>
      <html:hidden name="tranImportTaAF" property="orgInName"/>
      <html:hidden name="tranImportTaAF" property="noteNum"/>
            </td>
            <td  >&nbsp;</td>
          </tr>
        </table>
...
<form action="/hafmis/syscollection/tranmng/tranout/tran_showAC.do" method="POST" name="Form1" id="Form1">
</form>
</body>
</html:html>	  