...
function loads(){
	...
	if(tranoutId!=""){
		document.bizcheckDetailAF.elements["tranoutId"].value=format(document.bizcheckDetailAF.elements["tranoutId"].value)+document.bizcheckDetailAF.elements["tranoutId"].value;
	}
}
