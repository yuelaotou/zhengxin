...
<%@ page
	import="org.xpup.hafmis.syscollection.querystatistics.accountinfo.empaccountinfo.action.ShowEmpAccountDayListAC"%>

<%
			Object pagination = request.getSession(false).getAttribute(
			ShowEmpAccountDayListAC.PAGINATION_KEY);
...
<body bgcolor="#FFFFFF" text="#000000" onload="loads(); reportErrors();"
	...
	<jsp:include page="../../../../inc/sort.jsp">
		<jsp:param name="url" value="showEmpAccountDayListAC.do" />
	</jsp:include>
	...
	<form
		action="/hafmis/syscollection/querystatistics/accountinfo/empaccountinfo/showEmpAccountMonthListAC.do"
