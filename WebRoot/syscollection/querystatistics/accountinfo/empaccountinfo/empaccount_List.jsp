...
var startDate=document.empAccountAF.startDate.value.trim();
var lastDate = document.empAccountAF.lastDate.value.trim();
        var queryString = "emoAccountFindInforAAC.do?";
...
function gettr(trindex) {
 tr=trindex; 
   ...
   var queryString = "showEmpAccountMonthListAC.do?";
...
<body bgcolor="#FFFFFF" text="#000000" onload="loads(); reportErrors();"
	...
	<jsp:include page="../../../../inc/sort.jsp">
		<jsp:param name="url" value="showEmpAccountListAC.do" />
	</jsp:include>
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class=td3>
							<html:form action="/findEmpAccountListAC.do">
								<table width="95%" border="0" cellspacing="0" cellpadding="0"
									align="center">
									<tr>
										<td height="35">
									...
									<logic:notEmpty name="empAccountAF" property="list">
										...
										<logic:iterate name="empAccountAF" property="list"
											...
											<tr id="tr<%=i%>"
												...
												<td valign="top">
													<bean:write name="element" property="emp.balance" />
												</td>
											</tr>
										</logic:iterate>
									</logic:notEmpty>
