...
<script type="text/javascript">
	...
	loginReg();
	//加载模板文件..
	document.forms(0).Cell1.openfile("<%=path%>/syscollection/querystatistics/paymentpickstatistics/paymentyearstatistics/report/paymentyearstatistics1.cll","");
...
//十二月
  ...
  //合计
	...
	%>
	    ...
	    document.forms(0).Cell1.S(5,4,0,"<%=date %>");
	    document.forms(0).Cell1.S(10,21,0,"<%=userName %>");
	    //-------一月-------
		...
		//中行
		document.forms(0).Cell1.S(5,7,0,"<%=zh_hs1 %>");
		document.forms(0).Cell1.S(6,7,0,"<%=zh_rs1 %>");
		document.forms(0).Cell1.d(7,7,0,"<%=zh_je1 %>");
		//工行
		document.forms(0).Cell1.S(8,7,0,"<%=gh_hs1 %>");
		document.forms(0).Cell1.S(9,7,0,"<%=gh_rs1 %>");
		document.forms(0).Cell1.d(10,7,0,"<%=gh_je1 %>");
		//建行
		document.forms(0).Cell1.S(11,7,0,"<%=jh_hs1 %>");
		document.forms(0).Cell1.S(12,7,0,"<%=jh_rs1 %>");
		document.forms(0).Cell1.d(13,7,0,"<%=jh_je1 %>");
		//合计
		document.forms(0).Cell1.d(14,7,0,"<%=sum_1 %>");
		...
		//中行
		document.forms(0).Cell1.S(5,8,0,"<%=zh_hs2 %>");
		document.forms(0).Cell1.S(6,8,0,"<%=zh_rs2 %>");
		document.forms(0).Cell1.d(7,8,0,"<%=zh_je2 %>");
		//工行
		document.forms(0).Cell1.S(8,8,0,"<%=gh_hs2 %>");
		document.forms(0).Cell1.S(9,8,0,"<%=gh_rs2 %>");
		document.forms(0).Cell1.d(10,8,0,"<%=gh_je2 %>");
		//建行
		document.forms(0).Cell1.S(11,8,0,"<%=jh_hs2 %>");
		document.forms(0).Cell1.S(12,8,0,"<%=jh_rs2 %>");
		document.forms(0).Cell1.d(13,8,0,"<%=jh_je2 %>");
		//合计
		document.forms(0).Cell1.d(14,8,0,"<%=sum_2 %>");
		...
		//中行
		document.forms(0).Cell1.S(5,9,0,"<%=zh_hs3 %>");
		document.forms(0).Cell1.S(6,9,0,"<%=zh_rs3 %>");
		document.forms(0).Cell1.d(7,9,0,"<%=zh_je3 %>");
		//工行
		document.forms(0).Cell1.S(8,9,0,"<%=gh_hs3 %>");
		document.forms(0).Cell1.S(9,9,0,"<%=gh_rs3 %>");
		document.forms(0).Cell1.d(10,9,0,"<%=gh_je3 %>");
		//建行
		document.forms(0).Cell1.S(11,9,0,"<%=jh_hs3 %>");
		document.forms(0).Cell1.S(12,9,0,"<%=jh_rs3 %>");
		document.forms(0).Cell1.d(13,9,0,"<%=jh_je3 %>");
		//合计
		document.forms(0).Cell1.d(14,9,0,"<%=sum_3 %>");
		...
		//中行
		document.forms(0).Cell1.S(5,10,0,"<%=zh_hs4 %>");
		document.forms(0).Cell1.S(6,10,0,"<%=zh_rs4 %>");
		document.forms(0).Cell1.d(7,10,0,"<%=zh_je4 %>");
		//工行
		document.forms(0).Cell1.S(8,10,0,"<%=gh_hs4 %>");
		document.forms(0).Cell1.S(9,10,0,"<%=gh_rs4 %>");
		document.forms(0).Cell1.d(10,10,0,"<%=gh_je4 %>");
		//建行
		document.forms(0).Cell1.S(11,10,0,"<%=jh_hs4 %>");
		document.forms(0).Cell1.S(12,10,0,"<%=jh_rs4 %>");
		document.forms(0).Cell1.d(13,10,0,"<%=jh_je4 %>");
		//合计
		document.forms(0).Cell1.d(14,10,0,"<%=sum_4 %>");
		...
		//中行
		document.forms(0).Cell1.S(5,11,0,"<%=zh_hs5 %>");
		document.forms(0).Cell1.S(6,11,0,"<%=zh_rs5 %>");
		document.forms(0).Cell1.d(7,11,0,"<%=zh_je5 %>");
		//工行
		document.forms(0).Cell1.S(8,11,0,"<%=gh_hs5 %>");
		document.forms(0).Cell1.S(9,11,0,"<%=gh_rs5 %>");
		document.forms(0).Cell1.d(10,11,0,"<%=gh_je5 %>");
		//建行
		document.forms(0).Cell1.S(11,11,0,"<%=jh_hs5 %>");
		document.forms(0).Cell1.S(12,11,0,"<%=jh_rs5 %>");
		document.forms(0).Cell1.d(13,11,0,"<%=jh_je5 %>");
		//合计
		document.forms(0).Cell1.d(14,11,0,"<%=sum_5 %>");
		...
		//中行
		document.forms(0).Cell1.S(5,12,0,"<%=zh_hs6 %>");
		document.forms(0).Cell1.S(6,12,0,"<%=zh_rs6 %>");
		document.forms(0).Cell1.d(7,12,0,"<%=zh_je6 %>");
		//工行
		document.forms(0).Cell1.S(8,12,0,"<%=gh_hs6 %>");
		document.forms(0).Cell1.S(9,12,0,"<%=gh_rs6 %>");
		document.forms(0).Cell1.d(10,12,0,"<%=gh_je6 %>");
		//建行
		document.forms(0).Cell1.S(11,12,0,"<%=jh_hs6 %>");
		document.forms(0).Cell1.S(12,12,0,"<%=jh_rs6 %>");
		document.forms(0).Cell1.d(13,12,0,"<%=jh_je6 %>");
		//合计
		document.forms(0).Cell1.d(14,12,0,"<%=sum_6 %>");
		...
		//中行
		document.forms(0).Cell1.S(5,13,0,"<%=zh_hs7 %>");
		document.forms(0).Cell1.S(6,13,0,"<%=zh_rs7 %>");
		document.forms(0).Cell1.d(7,13,0,"<%=zh_je7 %>");
		//工行
		document.forms(0).Cell1.S(8,13,0,"<%=gh_hs7 %>");
		document.forms(0).Cell1.S(9,13,0,"<%=gh_rs7 %>");
		document.forms(0).Cell1.d(10,13,0,"<%=gh_je7 %>");
		//建行
		document.forms(0).Cell1.S(11,13,0,"<%=jh_hs7 %>");
		document.forms(0).Cell1.S(12,13,0,"<%=jh_rs7 %>");
		document.forms(0).Cell1.d(13,13,0,"<%=jh_je7 %>");
		//合计
		document.forms(0).Cell1.d(14,13,0,"<%=sum_7 %>");
		...
		//中行
		document.forms(0).Cell1.S(5,14,0,"<%=zh_hs8 %>");
		document.forms(0).Cell1.S(6,14,0,"<%=zh_rs8 %>");
		document.forms(0).Cell1.d(7,14,0,"<%=zh_je8 %>");
		//工行
		document.forms(0).Cell1.S(8,14,0,"<%=gh_hs8 %>");
		document.forms(0).Cell1.S(9,14,0,"<%=gh_rs8 %>");
		document.forms(0).Cell1.d(10,14,0,"<%=gh_je8 %>");
		//建行
		document.forms(0).Cell1.S(11,14,0,"<%=jh_hs8 %>");
		document.forms(0).Cell1.S(12,14,0,"<%=jh_rs8 %>");
		document.forms(0).Cell1.d(13,14,0,"<%=jh_je8 %>");
		//合计
		document.forms(0).Cell1.d(14,14,0,"<%=sum_8 %>");
		...
		//中行
		document.forms(0).Cell1.S(5,15,0,"<%=zh_hs9 %>");
		document.forms(0).Cell1.S(6,15,0,"<%=zh_rs9 %>");
		document.forms(0).Cell1.d(7,15,0,"<%=zh_je9 %>");
		//工行
		document.forms(0).Cell1.S(8,15,0,"<%=gh_hs9 %>");
		document.forms(0).Cell1.S(9,15,0,"<%=gh_rs9 %>");
		document.forms(0).Cell1.d(10,15,0,"<%=gh_je9 %>");
		//建行
		document.forms(0).Cell1.S(11,15,0,"<%=jh_hs9 %>");
		document.forms(0).Cell1.S(12,15,0,"<%=jh_rs9 %>");
		document.forms(0).Cell1.d(13,15,0,"<%=jh_je9 %>");
		//合计
		document.forms(0).Cell1.d(14,15,0,"<%=sum_9 %>");
		...
		//中行
		document.forms(0).Cell1.S(5,16,0,"<%=zh_hs10 %>");
		document.forms(0).Cell1.S(6,16,0,"<%=zh_rs10 %>");
		document.forms(0).Cell1.d(7,16,0,"<%=zh_je10 %>");
		//工行
		document.forms(0).Cell1.S(8,16,0,"<%=gh_hs10 %>");
		document.forms(0).Cell1.S(9,16,0,"<%=gh_rs10 %>");
		document.forms(0).Cell1.d(10,16,0,"<%=gh_je10 %>");
		//建行
		document.forms(0).Cell1.S(11,16,0,"<%=jh_hs10 %>");
		document.forms(0).Cell1.S(12,16,0,"<%=jh_rs10 %>");
		document.forms(0).Cell1.d(13,16,0,"<%=jh_je10 %>");
		//合计
		document.forms(0).Cell1.d(14,16,0,"<%=sum_10 %>");
		...
		//中行
		document.forms(0).Cell1.S(5,17,0,"<%=zh_hs11 %>");
		document.forms(0).Cell1.S(6,17,0,"<%=zh_rs11 %>");
		document.forms(0).Cell1.d(7,17,0,"<%=zh_je11 %>");
		//工行
		document.forms(0).Cell1.S(8,17,0,"<%=gh_hs11 %>");
		document.forms(0).Cell1.S(9,17,0,"<%=gh_rs11 %>");
		document.forms(0).Cell1.d(10,17,0,"<%=gh_je11 %>");
		//建行
		document.forms(0).Cell1.S(11,17,0,"<%=jh_hs11 %>");
		document.forms(0).Cell1.S(12,17,0,"<%=jh_rs11 %>");
		document.forms(0).Cell1.d(13,17,0,"<%=jh_je11 %>");
		//合计
		document.forms(0).Cell1.d(14,17,0,"<%=sum_11 %>");
		...
		//中行
		document.forms(0).Cell1.S(5,18,0,"<%=zh_hs12 %>");
		document.forms(0).Cell1.S(6,18,0,"<%=zh_rs12 %>");
		document.forms(0).Cell1.d(7,18,0,"<%=zh_je12 %>");
		//工行
		document.forms(0).Cell1.S(8,18,0,"<%=gh_hs12 %>");
		document.forms(0).Cell1.S(9,18,0,"<%=gh_rs12 %>");
		document.forms(0).Cell1.d(10,18,0,"<%=gh_je12 %>");
		//建行
		document.forms(0).Cell1.S(11,18,0,"<%=jh_hs12 %>");
		document.forms(0).Cell1.S(12,18,0,"<%=jh_rs12 %>");
		document.forms(0).Cell1.d(13,18,0,"<%=jh_je12 %>");
		//合计
		document.forms(0).Cell1.d(14,18,0,"<%=sum_12 %>");
		...
		//中行
		document.forms(0).Cell1.S(5,19,0,"<%=sum_d %>");
		document.forms(0).Cell1.S(6,19,0,"<%=sum_e %>");
		document.forms(0).Cell1.d(7,19,0,"<%=sum_f %>");
		//工行
		document.forms(0).Cell1.S(8,19,0,"<%=sum_g %>");
		document.forms(0).Cell1.S(9,19,0,"<%=sum_h %>");
		document.forms(0).Cell1.d(10,19,0,"<%=sum_i %>");
		//建行
		document.forms(0).Cell1.S(11,19,0,"<%=sum_g %>");
		document.forms(0).Cell1.S(12,19,0,"<%=sum_k %>");
		document.forms(0).Cell1.d(13,19,0,"<%=sum_l %>");
		//合计
		document.forms(0).Cell1.d(14,19,0,"<%=sum_m %>");
}
