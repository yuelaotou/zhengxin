...
<script type="text/javascript">
	...
	loginReg();
	//加载模板文件..
	document.forms(0).Cell1.openfile("<%=path%>/syscollection/querystatistics/paymentpickstatistics/paymentyearstatistics/report/paymentyearstatistics4.cll","");
...
//十二月
  ...
  //合计
	...
	%>
	    ...
	    document.forms(0).Cell1.S(4,4,0,"<%=date %>");
	    document.forms(0).Cell1.S(8,21,0,"<%=userName %>");
	    //-------一月-------
		...
		//合计
		document.forms(0).Cell1.d(8,7,0,"<%=sum_1 %>");
		...
		//合计
		document.forms(0).Cell1.d(8,8,0,"<%=sum_2 %>");
		...
		//合计
		document.forms(0).Cell1.d(8,9,0,"<%=sum_3 %>");
		...
		//合计
		document.forms(0).Cell1.d(8,10,0,"<%=sum_4 %>");
		...
		//合计
		document.forms(0).Cell1.d(8,11,0,"<%=sum_5 %>");
		...
		//合计
		document.forms(0).Cell1.d(8,12,0,"<%=sum_6 %>");
		...
		//合计
		document.forms(0).Cell1.d(8,13,0,"<%=sum_7 %>");
		...
		//合计
		document.forms(0).Cell1.d(8,14,0,"<%=sum_8 %>");
		...
		//合计
		document.forms(0).Cell1.d(8,15,0,"<%=sum_9 %>");
		...
		//合计
		document.forms(0).Cell1.d(8,16,0,"<%=sum_10 %>");
		...
		//合计
		document.forms(0).Cell1.d(8,17,0,"<%=sum_11 %>");
		...
		//合计
		document.forms(0).Cell1.d(8,18,0,"<%=sum_12 %>");
		...
		//合计
		document.forms(0).Cell1.d(8,19,0,"<%=sum_m %>");
}
