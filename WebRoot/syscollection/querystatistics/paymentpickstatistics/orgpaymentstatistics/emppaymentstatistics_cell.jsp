...
<html>
  ...
  <script type="text/javascript">
	...
	loginReg();
	document.forms(0).Cell1.openfile("<%=path%>/syscollection/querystatistics/paymentpickstatistics/report/emppaymentstatistics.cll","");
	...
	var i=0;
	<%
    		List list=(List) request.getSession().getAttribute("emppaymentprintlist");
 	...
 	%>
		...
		document.forms(0).Cell1.S(1,4,0,"<%=af.getEmpId() %>");
		document.forms(0).Cell1.S(2,4,0,"<%=af.getEmpName() %>");
		...
		if(k%totalPageLine==0&&k>0)
			{
				...
				pageCurrent++;	
				completeline=k-2;				
				document.forms(0).Cell1.insertSheetFromFile("<%=path%>/syscollection/querystatistics/paymentpickstatistics/report/emppaymentstatistics.cll",0,1,pageCurrent);
