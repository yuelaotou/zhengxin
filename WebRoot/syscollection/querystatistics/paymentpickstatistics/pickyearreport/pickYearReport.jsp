...
<%@ page
	import="org.xpup.hafmis.syscollection.querystatistics.paymentpickstatistics.pickyearreport.action.PickYearReportShowAC"%>
<%@ include file="/checkUrl.jsp"%>
<%
	String path = request.getContextPath();
	Object pagination = request.getSession(false).getAttribute(
			PickYearReportShowAC.PAGINATION_KEY);
...
<body bgcolor="#FFFFFF" text="#000000" onContextmenu="return false">
	<table width="1500" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td class=td3>
				<html:form action="/pickYearReportFindAC.do" style="margin:0">
					...
					<table border="0" width="95%" id="table1" cellspacing="1"
						...
						<tr>
							...
							<td width="16%">
								<html:text name="af" property="date" maxlength="6"
				...
				<html:form action="/pickYearReportMaintainAC.do">
						...
						<logic:notEmpty name="infoList">
							...
							<logic:iterate id="e" name="infoList" indexId="i">
								...
								<tr class="<%=strClass %>" align="center">
									<td>
										<bean:write name="e" property="month" />
									</td>
									<td>
