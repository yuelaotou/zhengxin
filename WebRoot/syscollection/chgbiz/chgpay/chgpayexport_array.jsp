...
function goClose() {
   window.opener.document.URL="<%=path%>/syscollection/chgbiz/chgpay/chgPayExportAC.do?tatol="+document.chgPayExport.elements["tatol"].value+"&empIds="+document.chgPayExport.elements["empIds"].value+"&empNames="+document.chgPayExport.elements["empNames"].value
  +"&salaryBases="+document.chgPayExport.elements["salaryBases"].value+"&orgId="+document.chgPayExport.elements["orgId"].value+"&chgMonth="+document.chgPayExport.elements["chgMonth"].value+"&orgPays="+document.chgPayExport.elements["orgPays"].value+"&orgName="+document.chgPayExport.elements["orgName"].value+"";
	window.close();
}
...
function reportErrors() {
	...
	<body bgcolor="#FFFFFF" text="#000000" onload="reportErrors();"
		...
		<form action="<%=path%>/syscollection/chgbiz/chgpay/chgPayExportAC.do"
			...
			<table width="95%" border="0" cellspacing="0" cellpadding="3"
				...
				<tr>
					...
					<td class="td1" align="center" valign="left">
						<input type="checkbox" name="empName"  value="0" onclick = "return changeArray('empName');">&nbsp&nbsp&nbsp职工姓名&nbsp&nbsp&nbsp
				...
				<td class="td1" align="center" valign="right">    
					...
					<td class="td1" align="center" valign="left">
						<input type="checkbox" name="orgPay"  value="0" onclick = "return changeArray('orgPay');">月缴金额
						<input type="test" name="orgPays"  value="0" style="width:20px" readonly >
					<td class="td1" align="center" valign="left">
						<input type="checkbox" name="salaryBase"  value="0" onclick = "return changeArray('salaryBase');">&nbsp&nbsp&nbsp工资基数&nbsp&nbsp&nbsp
