...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
          ...
          <td background="<%=path%>/img/table_bg_line.gif" align="right"> 
            <table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="216" class=font14 bgcolor="#FFFFFF" align="center" valign="bottom"><font color="00B5DB"> 变更业务 &gt; 工资基数调整 </font></td>
   ...
   <tr> 
    <td class=td3>
    <html:form action="/chgslarybaseTaImportAC" style="margin: 0" enctype="multipart/form-data">
      <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="35"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table border="0" width="95%" id="table1" cellspacing=1  cellpadding=3 align="center" >
          <tr> 
            <td width="17%" class="td1"  >工资基数调整导入:</td>
            <td width="38%"   > 
		      <html:file name="chgslarybaseImportTaAF" property="theFile" />
              <html:hidden property="url"/>
               <html:hidden name="chgslarybaseImportTaAF" property="orgId"/>
               <html:hidden name="chgslarybaseImportTaAF" property="chgMonth"/>
            </td>
            <td  >&nbsp;</td>
          </tr>
        </table>
...
<form action="<%=path%>/syscollection/chgbiz/chgslarybase/chgslarybaseTaShowAC.do" method="POST" name="Form1" id="Form1">
</form>
</body>
</html:html>	  