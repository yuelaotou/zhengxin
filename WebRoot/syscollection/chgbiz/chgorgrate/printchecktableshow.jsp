...
function reportErrors() {
	...
	document.printCheckTableAF.orgid.value="";
	document.printCheckTableAF.orgid.focus();
}
function checkOrgId(){
	var orgid = document.printCheckTableAF.orgid.value;
	if(orgid==""){
		alert("单位编号为空！！！");
		document.printCheckTableAF.orgid.value="";
		document.printCheckTableAF.orgid.focus();
	...
	<table width="95%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td class=td3>
				...
				<html:form action="/printCheckTableShowAC.do">
						...
						<tr>
							...
							<td width="20%">
								<html:text property="orgid" styleClass="input3"
									name="printCheckTableAF"></html:text>
							</td>
						</tr>
					</table>
