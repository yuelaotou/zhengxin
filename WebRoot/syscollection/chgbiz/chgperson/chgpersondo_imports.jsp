...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
          ...
          <td background="<%=path%>/img/table_bg_line.gif" align="right"> 
            <table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="216" class=font14 bgcolor="#FFFFFF" align="center" valign="bottom"><font color="00B5DB">变更业务</font><font color="00B5DB">&gt;人员变更</font></td>
   ...
   <tr> 
    <td class=td3>
    <html:form action="/chgpersonImportAC" style="margin: 0" enctype="multipart/form-data">
      <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="35"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<form action="<%=path%>/syscollection/chgbiz/chgperson/showChgpersonDoListAC.do" method="POST" name="Form1" id="Form1">
</form>
</body>
</html:html>	  