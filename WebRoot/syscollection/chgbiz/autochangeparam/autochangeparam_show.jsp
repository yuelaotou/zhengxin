...
<script>
function onCheck(){
	var v3=document.forms[0].elements["autoChangeParamDTO.isAutoChange"];
...
<body bgcolor="#FFFFFF" text="#000000" onContextmenu="return false">
	<table width="95%" border="0" cellspacing="0" cellpadding="0"
							...
							<table width="300" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="234" class=font14 bgcolor="#FFFFFF" align="center"
										valign="bottom">
										<font color="00B5DB">变更业务&gt;自动变更参数设置</font>
									</td>
		...
		<tr>
			<td class=td3>
			<html:form action="/autoChangeParamSaveAC.do">
				<table width="95%" border="0" cellspacing="0" cellpadding="0"
					align="center">
					<tr>
						<td height="35">
				...
				<table border="0" width="95%" id="table1" cellspacing=1
					...
					<tr id="tr1">
						...
						<td width="97%" class="td1">
							<p>
								可进行自动变更
								<html:radio name="autoChangeParamAF" property="autoChangeParamDTO.isAutoChange" value="0" onkeydown="enterNextFocus1();"/>
								不启用
								<html:radio name="autoChangeParamAF" property="autoChangeParamDTO.isAutoChange" value="1" onkeydown="enterNextFocus1();"/>
								启用；
							</p>
						</td>
					</tr>
