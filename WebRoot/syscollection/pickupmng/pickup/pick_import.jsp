  ...
  <head>
   ...
   function on_Submit(eee){  
    if(document.forms[0].theFile.value==""){
	     alert("请选择导入文件！！！");//文件不能为Null
	     return false;
     }else{
     	document.forms[0].url.value=document.forms[0].theFile.value;//获得文件的绝对路径
          ...
          <td background="<%=path%>/img/table_bg_line.gif" align="right"> 
            <table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="216" class=font14 bgcolor="#FFFFFF" align="center" valign="bottom"><font color="00B5DB">提取业务&gt;普通提取</font></td>
    ...
    <td class=td3>
      <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
       ...
       <table border="0" width="95%" id="table1" cellspacing=1  cellpadding=3 align="center" >
          <tr> 
            <td width="17%" class="td1"  >提取管理导入:</td>
            <td width="38%"   > 
