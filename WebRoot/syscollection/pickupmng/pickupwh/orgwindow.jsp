...
<%@ page
	import="org.xpup.hafmis.syscollection.pickupmng.pickupwh.action.WehuwindowshowAC"%>
<%@ include file="/checkUrl.jsp"%>
<%
			Object pagination = request.getSession(false).getAttribute(
			WehuwindowshowAC.EMPLOYEELIST);
...
var query;
	function print(){
	 query = 'weihuprintAC.do?';
	 printreal(query);
 		//document.URL='printEmployeeAC.do?';
	}
 function printpz(){
	var empid=update();
	 query ='weihuprintAC.do?empid='+empid;
	printreal(query);
	}
...
function gettr(trindex) {//点单选行的时候 触发这个函数
 ...
 update();
	...
	update();
 	 //	document.form.elements["id"].value=format(document.form.elements["id"].value)+document.form.elements["id"].value;
...
//-->
	...
	<body bgcolor="#FFFFFF" text="#000000" onload="loads();"
		...
		<html:form action="/whwindowMaintainAC.do">
										...
										<tr>
											...
											<td align="right">
												<jsp:include page="../../../inc/pagination.jsp">
													<jsp:param name="url" value="wehuwindowshowAC.do" />
												</jsp:include>
											</td>
										</tr>
									</table>
