          ...
          <td background="../../../img/table_bg_line.gif" align="right"> 
            <table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="190" class=font14 bgcolor="#FFFFFF" align="center" valign="bottom"><font color="00B5DB"> 职工还款情况</font>  </td>
  ...
  <tr> 
    <td class=td3> 
      <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="35"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="22" bgcolor="#CCCCCC" align="center" width="153"><b class="font14">查 询 条 件</b></td>
                <td width="529" height="22" align="right" background="../../../img/bg2.gif">&nbsp;                </td>
              </tr>
            </table>
        ...
        <tr bgcolor="1BA5FF" > 
          <td align="center" height="6" colspan="1" ></td>
			...
			<table border="0" width="100%" id="table1" cellspacing=1  cellpadding=0 align="center">
        <tr> 
          <td width="17%" height="35" class="td1">还款年月</td>
          <td width="33%"><input name="textfield" type="text" id="txtsearch" class="input3" onKeyDown="enterNextFocus1();" ></td>
          <td width="17%" class="td1">还款日期</td>
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr> 
                <td class=h4>合计：回收总金额<u>：1</u>回收本金<u>：1</u> 回收利息<u>：1</u> 回收罚息<u>：2</u></td>
          </tr>
      </table>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="22" bgcolor="#CCCCCC" align="center" width="202"><b class="font14">还 款 信 息</b></td>
                <td width="703" height="22" align="center" background="../../../img/bg2.gif">&nbsp; </td>
              </tr>
            </table>
          </td>
        </tr>
      ...
      <table width="95%" border="0" cellspacing="0" cellpadding="3" align="center">
        <form name="form1">
          <tr > 
            <td align="center" bgcolor="C4F0FF" > 还款年月</td>
            <td align="center" class=td2 > 总回收金额</td>
            <td align="center" class=td2 >回收本金</td>
            <td align="center" class=td2 >回收利息</td>
            <td align="center" class=td2 >回收罚息</td>
            <td align="center" class=td2 >贷款余额</td>
            <td align="center" class=td2 >还款日期</td>
          </tr>
          ...
          <tr id="tr3" onMouseOver='this.style.background="#eaeaea"'  onMouseOut='this.style.background="#ffffff"' > 
            <td valign="top">&nbsp;</td>
            <td valign="top">&nbsp;</td>
            <td valign="top">&nbsp;</td>
            <td valign="top">&nbsp;</td>
          ...
          <tr id="tr4" onMouseOver='this.style.background="#eaeaea"'  onMouseOut='this.style.background="#ffffff"' > 
            <td valign="top">&nbsp;</td>
            <td valign="top">&nbsp;</td>
            <td valign="top">&nbsp;</td>
            <td valign="top">&nbsp;</td>
