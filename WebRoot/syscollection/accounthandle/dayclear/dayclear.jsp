...
function gettr(indextid){
	...
	if(arr.length==1){
		...
		document.idAF.rowArray[indextid.substring(2,indextid.length)].value=document.idAF.rowArray[indextid.substring(2,indextid.length)].value.substring(0,2)+date;
	}
												...
												<tr id="tr<%=m%>"  class="<%=strClass%>">
													...
													<td >
														<html:multibox property="rowArray" >
															<%=dto.getCollBankId() %>,<%=dto.getCollBankDate() %>
														</html:multibox>
													</td>
													<td valign="top" >
														<%=dto.getCollBankName() %>
													...
													<td valign="top" >
														...
														<select id="select<%=m%>" name="id" onchange='gettr("tr<%=m%>");'>
