...
<html>
  ...
  <script type="text/javascript">
	function load(){
	loginReg();
	document.forms(0).Cell1.openfile("<%=path%>/syscollection/accounthandle/clearaccount/report/19_1.cll","");
	<%
	...
	%>	
		...
		//时间
		document.forms(0).Cell1.S(5,4,0,"<%=setDate.substring(0,4)%>年"+"<%=setDate.substring(4,6)%>月"+"<%=setDate.substring(6,8)%>日");
		document.forms(0).Cell1.S(11,4,0,"<%=userName%>");
		//贷
		document.forms(0).Cell1.S(2,7,0,"<%=f.getOrg_payment_count() %>");
		document.forms(0).Cell1.d(4,7,0,"<%=f.getOrg_payment_balance() %>");
		document.forms(0).Cell1.S(2,8,0,"<%=f.getOrg_add_payment_count() %>");
		document.forms(0).Cell1.d(4,8,0,"<%=f.getOrg_add_payment_balance() %>");
		document.forms(0).Cell1.S(2,9,0,"<%=f.getEmp_add_payment_count() %>");
		document.forms(0).Cell1.d(4,9,0,"<%=f.getEmp_add_payment_balance() %>");
		...
		document.forms(0).Cell1.d(4,10,0,"<%=f.getOrg_over_paybalance() %>");
		document.forms(0).Cell1.S(2,11,0,"<%=f.getXiaoji1_credit_count() %>");
		document.forms(0).Cell1.d(4,11,0,"<%=f.getXiaoji1_credit_paybalance() %>");
		document.forms(0).Cell1.S(2,12,0,"<%=f.getAdjustaccout_credit_count() %>");
		document.forms(0).Cell1.d(4,12,0,"<%=f.getAdjustaccout_credit_paybalance() %>");
		document.forms(0).Cell1.S(2,13,0,"<%=f.getOrg_tranin_count() %>");
		document.forms(0).Cell1.d(4,13,0,"<%=f.getOrg_tranin_paybalance() %>");
		
		document.forms(0).Cell1.S(2,15,0,"<%=f.getClearinteres_count() %>");
		document.forms(0).Cell1.d(4,15,0,"<%=f.getClearinteres_paybalance() %>");
		document.forms(0).Cell1.S(2,16,0,"<%=f.getClearinteres_count() %>");
		document.forms(0).Cell1.d(4,16,0,"<%=f.getClearinteres_paybalance_1() %>");
		document.forms(0).Cell1.S(2,17,0,"<%=f.getClearinteres_count() %>");
		document.forms(0).Cell1.d(4,17,0,"<%=f.getXiaoji3_credit_paybalance() %>");
		
		document.forms(0).Cell1.S(2,14,0,"<%=f.getAdjustaccout_credit_count().intValue()+f.getOrg_tranin_count().intValue() %>");
		document.forms(0).Cell1.d(4,14,0,"<%=f.getAdjustaccout_credit_paybalance().add(f.getOrg_tranin_paybalance()) %>");
		document.forms(0).Cell1.S(2,18,0,"<%=f.getCredit_count() %>");
		document.forms(0).Cell1.d(4,18,0,"<%=f.getCredit_paybalance() %>");
		...
		document.forms(0).Cell1.d(10,13,0,"<%=f.getOrg_tranout_balance() %>");
		document.forms(0).Cell1.S(8,7,0,"<%=f.getPick_count() %>");
		document.forms(0).Cell1.d(10,7,0,"<%=f.getPick_balance() %>");
		document.forms(0).Cell1.S(8,8,0,"<%=f.getPick_payload_count() %>");
		document.forms(0).Cell1.d(10,8,0,"<%=f.getPick_payload_balance() %>");
		document.forms(0).Cell1.S(8,9,0,"<%=f.getPick_payload_count_ld() %>");
		document.forms(0).Cell1.d(10,9,0,"<%=f.getPick_payload_balance_ld() %>");
		
		document.forms(0).Cell1.S(8,10,0,"<%=f.getPick_count_xiaohu() %>");
		document.forms(0).Cell1.d(10,10,0,"<%=f.getPick_balance_xiaohu() %>");
		document.forms(0).Cell1.S(8,11,0,"<%=f.getDebit_count_xiaoji()%>");
		document.forms(0).Cell1.d(10,11,0,"<%=f.getDebit_paybalance_xiaoji() %>");
		document.forms(0).Cell1.S(11,13,0,"<%=f.getOrg_tranout_count() %>");
		document.forms(0).Cell1.S(13,13,0,"<%=f.getOrg_tranout_balance() %>");
		
		document.forms(0).Cell1.S(8,14,0,"<%=f.getAdjustaccout_debit_count().intValue()+ f.getOrg_tranout_count().intValue()%>");
		document.forms(0).Cell1.d(10,14,0,"<%=f.getAdjustaccout_debit_paybalance().add(f.getOrg_tranout_balance()) %>");
		
		
		
		document.forms(0).Cell1.S(8,12,0,"<%=f.getAdjustaccout_debit_count() %>");
		document.forms(0).Cell1.d(10,12,0,"<%=f.getAdjustaccout_debit_paybalance() %>");
		document.forms(0).Cell1.S(8,18,0,"<%=f.getDebit_count() %>");
		document.forms(0).Cell1.d(10,18,0,"<%=f.getDebit_paybalance() %>");
		
		
		document.forms(0).Cell1.d(2,19,0,"<%=f.getPre_rest_paybalance() %>");
		document.forms(0).Cell1.d(5,19,0,"<%=f.getPre_debit_paybalance() %>");
		document.forms(0).Cell1.d(10,19,0,"<%=f.getGjjYuE()%>");
		document.forms(0).Cell1.d(10,20,0,"<%=f.getCur_rest_paybalance() %>");
		document.forms(0).Cell1.d(2,20,0,"<%=f.getDebit_interest_paybalance()%>");
		document.forms(0).Cell1.d(5,20,0,"<%=f.getOrg_overpay_sum()%>");
