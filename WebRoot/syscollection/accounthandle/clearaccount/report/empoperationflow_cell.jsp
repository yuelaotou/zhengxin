...
<html>
  ...
  <script type="text/javascript">
	...
	loginReg();
	document.forms(0).Cell1.openfile("/hafmis/syscollection/querystatistics/operationflow/report/empoperationflow.cll","");
		...
		if(k%totalPageLine==0&&k>0)
			{
				...
				pageCurrent++;	
				completeline=k-2;				
				document.forms(0).Cell1.insertSheetFromFile("/hafmis/syscollection/querystatistics/operationflow/report/empoperationflow.cll",0,1,pageCurrent);
		...
		if(pageCurrent==0)
			{
				...
				document.forms(0).Cell1.S(3,k+6,0,orgid[k]);
