...
function loads(){
	var tranoutId=document.bizcheckDetailAF.elements["tranoutId"].value;
	if(tranoutId!=""){
		document.bizcheckDetailAF.elements["tranoutId"].value=formatTen(document.bizcheckDetailAF.elements["tranoutId"].value)+document.bizcheckDetailAF.elements["tranoutId"].value;
	}
}
					...
					<td class=td3>
						...
						<table border="0" width="95%" id="table1" cellspacing=1
							...
							<tr>
								...
								<td width="33%">
									<html:text name="bizcheckDetailAF" property="tranoutId"
										styleClass="input3" readonly="true" />
								</td>
								<td width="17%" class=td1>
									转出单位名称
								...
								<td width="33%">
									<html:text name="bizcheckDetailAF" property="tranoutName"
										styleClass="input3" readonly="true" />
								</td>
							</tr>
							<tr>
