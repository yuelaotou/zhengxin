...
<%@ page import="org.xpup.hafmis.syscollection.systemmaintain.hafoperateLog.action.HafoperatorLogShowAC" %>
        ...
        <table border="0" width="95%" id="table1" cellspacing=1  cellpadding=0 align="center" >
          <tr> 
            ...
            <td width="33%" colspan="3"  > 
             <html:select property="opmodle" styleClass="input4" onkeydown="enterNextFocus1();"  >
            ...
            <td width="33%" colspan="3"  > 
             <html:select property="oper" styleClass="input4" onkeydown="enterNextFocus1();"  >
              <html:option value=""></html:option>                    
          ...
          <tr> 
            ...
            <td width="15%"  > 
                <html:text name="hafoperateLogAF" property="starttime" onkeydown="enterNextFocus1();"  styleClass="input3" styleId="txtsearch"></html:text>
            </td>
            <td width="4%" align="center" >至</td>
            <td width="14%"  >
                <html:text name="hafoperateLogAF" property="endtime" onkeydown="enterNextFocus1();"  styleClass="input3" styleId="txtsearch"></html:text>
            </td>
            <td width="17%" class="td1" >操作动作</td>
            <td width="33%"  > 
             <html:select property="opaction" styleClass="input4" onkeydown="enterNextFocus1();"  >
              <html:option value=""></html:option>
        ...
        <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr > 
            ...
            <td align="center" class=td2 >
	          	<a href="javascript:sort('hafOperateLog.opModel')">操作模块</a>
	          	<logic:equal name="pagination" property="orderBy" value="hafOperateLog.opModel">
            ...
            <td align="center" class=td2 >
	          	<a href="javascript:sort('hafOperateLog.opButton')">操作动作</a>
	          	<logic:equal name="pagination" property="orderBy" value="hafOperateLog.opButton">
	          	  <logic:equal name="pagination" property="orderother" value="ASC">▲</logic:equal>
	          	  <logic:equal name="pagination" property="orderother" value="DESC">▼</logic:equal>
	          	</logic:equal>
            </td>
            <td align="center" class=td2 >
	          	<a href="javascript:sort('hafOperateLog.opIp')">操作IP</a>
	          	<logic:equal name="pagination" property="orderBy" value="hafOperateLog.opIp">
	          	  <logic:equal name="pagination" property="orderother" value="ASC">▲</logic:equal>
	          	  <logic:equal name="pagination" property="orderother" value="DESC">▼</logic:equal>
	          	</logic:equal>
            </td>
            <td align="center" class=td2 >
	          	<a href="javascript:sort('hafOperateLog.opBizId')">操作业务ID</a>
	          	<logic:equal name="pagination" property="orderBy" value="hafOperateLog.opBizId">
	          	  <logic:equal name="pagination" property="orderother" value="ASC">▲</logic:equal>
	          	  <logic:equal name="pagination" property="orderother" value="DESC">▼</logic:equal>
	          	</logic:equal>
            </td>
            <td align="center" class=td2 >操作时间</td>
          	<td align="center" class=td2 >
	          	<a href="javascript:sort('hafOperateLog.operator')">操作员</a>
	          	<logic:equal name="pagination" property="orderBy" value="hafOperateLog.operator">
	          	  <logic:equal name="pagination" property="orderother" value="ASC">▲</logic:equal>
	          	  <logic:equal name="pagination" property="orderother" value="DESC">▼</logic:equal>
	          	</logic:equal>
            </td>
